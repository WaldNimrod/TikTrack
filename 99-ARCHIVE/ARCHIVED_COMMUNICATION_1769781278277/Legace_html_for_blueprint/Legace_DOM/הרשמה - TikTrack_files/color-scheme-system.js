    ...
    if (pageClass) {
      ...
      if (entityType && isValidEntityType(entityType)) {
        ...
        if (entityColor) {
          ...
          document.documentElement.classList.add('entity-color-active');
...
const PAGE_TO_ENTITY_MAPPING = {
  ...
  'trading_accounts-page': 'trading_account', // Trading accounts page - חשבונות מסחר
  'accounts-page': 'trading_account', // Alias - חשבונות מסחר
  'trades-page': 'trade',
  'tracking-page': 'trade', // Alias
  'alerts-page': 'alert',
  'cash_flows-page': 'cash_flow',
  'notes-page': 'note',
  'executions-page': 'execution',
  'trade_plans-page': 'trade_plan',
  'planning-page': 'trade_plan', // Alias
  'trading_journal-page': 'note', // Trading journal page - יומן מסחר
  ...
  'trade_history-page': 'trade', // Trade History page - uses trade colors
  'db_display-page': null, // Uses fixed gray color
  'db_extradata-page': null, // Uses fixed gray color
  ...
  'external_data-dashboard-page': 'development',
