...
const PACKAGE_MANIFEST = {
  ...
  base: {
    ...
    scripts: [
      ...
      {
        file: 'scripts/api-fetch-wrapper.js',
      ...
      {
        file: 'scripts/global-favicon.js',
      ...
      {
        file: 'scripts/cache-sync-manager.js',
      ...
      {
        file: 'scripts/error-handlers.js',
      ...
      {
        file: 'scripts/unified-cache-manager.js',
      ...
      {
        file: 'scripts/icon-replacement-helper.js',
      ...
      {
        file: 'scripts/cache-clear-menu.js',
      ...
      {
        file: 'scripts/cache-ttl-guard.js',
      ...
      {
        file: 'scripts/quick-quality-check.js',
      ...
      {
        file: 'scripts/page-state-manager.js',
      ...
      {
        file: 'scripts/button-system-init.js',
      ...
      {
        file: 'scripts/color-scheme-system.js',
      ...
      {
        file: 'scripts/debug-modal-z-index.js',
      ...
      // {
      //   file: 'scripts/modules/core-systems.js',
  ...
  'core-ui': {
    ...
    scripts: [
      ...
      {
        file: 'scripts/logger-service.js',
      ...
      {
        file: 'scripts/event-handler-manager.js',
  ...
  services: {
    ...
    scripts: [
      {
        file: 'scripts/services/data-collection-service.js',
      ...
      {
        file: 'scripts/services/date-range-picker-service.js',
      ...
      {
        file: 'scripts/services/field-renderer-service.js',
      ...
      {
        file: 'scripts/services/select-populator-service.js',
        globalCheck: 'window.SelectPopulatorService',
        description: 'Select box population service',
        required: false, // Changed to false - only load when needed
        loadOrder: 3
      },
      {
      ...
      {
        file: 'scripts/services/ai-analysis-data.js',
      ...
      {
        file: 'scripts/services/statistics-calculator.js',
      ...
      {
        file: 'scripts/services/default-value-setter.js',
      ...
      {
        file: 'scripts/services/executions-data.js',
      ...
      {
        file: 'scripts/services/crud-response-handler.js',
      ...
      {
        file: 'scripts/services/unified-crud-service.js',
      ...
      {
        file: 'scripts/services/research-data.js',
      ...
      {
        file: 'scripts/services/investment-calculation-service.js',
      ...
      {
        file: 'scripts/services/unified-progress-manager.js',
      ...
      {
        file: 'scripts/services/tag-service.js',
      ...
      {
        file: 'scripts/services/autocomplete-service.js',
      ...
      {
        file: 'scripts/services/widget-z-index-manager.js',
      ...
      {
        file: 'scripts/services/unified-ui-positioning-service.js',
      ...
      {
        file: 'scripts/services/widget-overlay-service.js',
      ...
      {
        file: 'scripts/services/widget-overlay-debugger.js',
      ...
      {
        file: 'scripts/services/table-sort-value-adapter.js',
      ...
      {
        file: 'scripts/services/lint-status-service.js',
      ...
      {
        file: 'scripts/services/alert-condition-renderer.js',
      ...
      {
        file: 'scripts/services/rich-text-editor-service.js',
      ...
      {
        file: 'scripts/services/pending-actions-cache-service.js',
      ...
      {
        file: 'scripts/services/execution-clustering-service.js',
      ...
      {
        file: 'scripts/services/execution-assignment-service.js',
      ...
      {
        file: 'scripts/services/trade-plan-assignment-service.js',
      ...
      {
        file: 'scripts/services/execution-cluster-helpers.js',
      ...
      {
        file: 'scripts/services/modal-helper-service.js',
  ...
  'ui-advanced': {
    ...
    scripts: [
      {
        file: 'scripts/table-mappings.js',
      ...
      {
        file: 'scripts/table-data-registry.js',
      ...
      {
        file: 'scripts/pagination-system.js',
      ...
      {
        file: 'scripts/modules/actions-menu-system.js',
  ...
  modules: {
    ...
    scripts: [
      {
        file: 'scripts/modal-navigation-manager.js',
      ...
      {
        file: 'scripts/modal-z-index-manager.js',
      ...
      {
        file: 'scripts/modal-z-index-monitor.js',
      ...
      {
        file: 'scripts/modal-backdrop-monitor.js',
      ...
      {
        file: 'scripts/modal-stack-monitor.js',
      ...
      {
        file: 'scripts/modal-quantum-system-tests.js',
      ...
      {
        file: 'scripts/tag-ui-manager.js',
      ...
      {
        file: 'scripts/modules/data-basic.js',
      ...
      {
        file: 'scripts/modules/ui-basic.js',
      ...
      {
        file: 'scripts/modules/data-advanced.js',
      ...
      {
        file: 'scripts/modules/ui-advanced.js',
      ...
      {
        file: 'scripts/modules/communication-module.js',
      ...
      {
        file: 'scripts/modules/business-module.js',
      ...
      {
        file: 'scripts/modules/localstorage-sync.js',
      ...
      {
        file: 'scripts/modules/dynamic-loader-config.js',
      ...
      {
        file: 'scripts/import-user-data.js',
      ...
      {
        file: 'scripts/modal-configs/trading-accounts-config.js',
      ...
      {
        file: 'scripts/modal-configs/alerts-config.js',
      ...
      {
        file: 'scripts/modal-configs/trades-config.js',
      ...
      {
        file: 'scripts/modal-configs/executions-config.js',
      ...
      {
        file: 'scripts/modal-configs/trade-plans-config.js',
      ...
      {
        file: 'scripts/modal-configs/tickers-config.js',
      ...
      {
        file: 'scripts/modal-configs/watch-lists-config.js',
      ...
      {
        file: 'scripts/modal-configs/cash-flows-config.js',
      ...
      {
        file: 'scripts/modal-configs/notes-config.js',
      ...
      {
        file: 'scripts/modal-configs/tag-management-config.js',
      ...
      {
        file: 'scripts/modal-configs/conditions-config.js',
      ...
      {
        file: 'scripts/modal-configs/tag-search-config.js',
      ...
      {
        file: 'scripts/modal-manager-v2.js',
  ...
  crud: {
    ...
    scripts: [
      ...
      {
        file: 'scripts/unified-table-system.js',
  ...
  'tag-management': {
    ...
    scripts: [
      {
        file: 'scripts/tag_management.js',
  ...
  // 5.3. DATA IMPORT PAGE PACKAGE - Data import
  'data-import': {
    id: 'data-import',
    name: 'Data Import Page Package',
    description: 'Dedicated logic for data import page',
    version: '1.0.0',
    critical: false,
    loadOrder: 5.3,
    dependencies: ['base', 'services', 'modules', 'ui-advanced', 'crud'],
    loadingStrategy: 'defer', // Critical package - data import, has dependencies on multiple packages
    scripts: [
      {
        file: 'scripts/data_import.js',
        globalCheck: 'window.initializeDataImportPage',
        description: 'Data import page display management',
        required: true,
        loadOrder: 1
      }
    ],
  ...
  preferences: {
    ...
    scripts: [
      {
        file: 'scripts/preferences-cache.js',
      ...
      {
        file: 'scripts/preferences-events.js',
      ...
      {
        file: 'scripts/preferences-ui-layer.js',
      ...
      {
        file: 'scripts/preferences-manager.js',
      ...
      {
        file: 'scripts/preferences-core.js',
      ...
      {
        file: 'scripts/preferences-colors.js',
      ...
      {
        file: 'scripts/preferences-profiles.js',
      ...
      {
        file: 'scripts/preferences-lazy-loader.js',
      ...
      {
        file: 'scripts/preferences-validation.js',
      ...
      {
        file: 'scripts/preferences-group-manager.js',
      ...
      {
        file: 'scripts/preferences-ui.js',
      ...
      {
        file: 'scripts/preferences-page.js',
      ...
      {
        file: 'scripts/testing/automated/preferences-browser-test.js',
  ...
  validation: {
    ...
    scripts: [
      {
        file: 'scripts/validation-utils.js',
  ...
  conditions: {
    ...
    scripts: [
      {
        file: 'scripts/conditions/conditions-translations.js',
      ...
      {
        file: 'scripts/conditions/conditions-validator.js',
      ...
      {
        file: 'scripts/conditions/conditions-form-generator.js',
      ...
      {
        file: 'scripts/conditions/conditions-crud-manager.js',
      ...
      {
        file: 'scripts/conditions/conditions-initializer.js',
      ...
      {
        file: 'scripts/conditions/conditions-ui-manager.js',
      ...
      {
        file: 'scripts/conditions/conditions-modal-controller.js',
  ...
  'external_data': {
    ...
    scripts: [
      {
        file: 'scripts/yahoo-finance-service.js',
        globalCheck: 'window.YahooFinanceService',
        description: 'Yahoo Finance service',
        required: true
      },
      {
        file: 'scripts/external-data-service.js',
  ...
  charts: {
    ...
    scripts: [
      ...
      {
        file: 'scripts/charts/chart-theme.js',
      ...
      {
        file: 'scripts/charts/chart-system.js',
      ...
      {
        file: 'scripts/charts/chart-loader.js',
      ...
      {
        file: 'scripts/charts/chart-export.js',
      ...
      {
        file: 'scripts/charts/adapters/performance-adapter.js',
      ...
      {
        file: 'scripts/charts/adapters/trades-adapter.js',
  ...
  logs: {
    ...
    scripts: [
      {
        file: 'scripts/unified-log-api.js',
      ...
      {
        file: 'scripts/unified-log-manager.js',
      ...
      {
        file: 'scripts/unified-log-display.js',
  ...
  cache: {
    ...
    scripts: [
      {
        file: 'scripts/cache-policy-manager.js',
  ...
  'entity-services': {
    ...
    scripts: [
      {
        file: 'scripts/services/trades-data.js',
      ...
      {
        file: 'scripts/services/trade-history-data.js',
        globalCheck: 'window.TradeHistoryData',
        description: 'Trade history data service',
        required: false,  // Required only for trade_history-page
        loadOrder: 8
      },
      {
        file: 'scripts/services/portfolio-state-data.js',
      ...
      {
        file: 'scripts/services/trading-journal-data.js',
        globalCheck: 'window.TradingJournalData',
        description: 'Trading journal data service',
        required: false,  // Required only for trading_journal-page
        loadOrder: 9
      },
      {
        file: 'scripts/trade-history-page.js',
      ...
      {
        file: 'scripts/trading-journal-page.js',
      ...
      {
        file: 'scripts/calendar/calendar-date-utils.js',
      ...
      {
        file: 'scripts/account-service.js',
      ...
      {
        file: 'scripts/ticker-service.js',
      ...
      {
        file: 'scripts/services/trade-plans-data.js',
        globalCheck: 'window.TradePlansData',
        description: 'Trade plans data service',
        required: false,  // Optional - not all pages need this
        loadOrder: 4.5
      },
      // REMOVED: trade-plan-service.js - file does not exist in filesystem
      // Use trade-plans-data.js or trade-plan-assignment-service.js instead
      {
        file: 'scripts/services/notes-data.js',
      ...
      {
        file: 'scripts/services/alerts-data.js',
        globalCheck: 'window.AlertsData',
        description: 'Alerts data service',
        required: false,
        loadOrder: 6.6
      },
      // Removed: services/tickers-data.js - not needed for testing pages, load only when required
      // {
      //   file: 'scripts/services/tickers-data.js',
      ...
      // },
      {
        file: 'scripts/services/trading-accounts-data.js',
      ...
      {
        file: 'scripts/services/cash-flows-data.js',
      ...
      {
        file: 'scripts/condition-translator.js',
      ...
      {
        file: 'scripts/services/linked-items-service.js',
      ...
      {
        file: 'scripts/account-activity.js',
      ...
      {
        file: 'scripts/positions-portfolio.js',
  ...
  helper: {
    ...
    scripts: [
      {
        file: 'scripts/utils/cache-key-helper.js',
      ...
      {
        file: 'scripts/utils/business-logic-batch-helper.js',
      ...
      {
        file: 'scripts/utils/request-deduplication-helper.js',
  ...
  'system-management': {
    ...
    scripts: [
      {
        file: 'scripts/system-management/system-management-main.js',
        globalCheck: 'window.SystemManagementMain',
        description: 'Main system management',
        required: true
      },
      {
        file: 'scripts/system-management/core/sm-base.js',
        globalCheck: 'window.SMBaseSection',
        description: 'System management base',
        required: true
      },
      {
        file: 'scripts/system-management/core/sm-error-handler.js',
        globalCheck: 'window.SMErrorHandler',
        description: 'System management error handler',
        required: true
      },
      {
        file: 'scripts/system-management/core/sm-data-validators.js',
        globalCheck: 'window.SMDataValidators',
        description: 'System management data validators',
        required: true
      },
      {
        file: 'scripts/system-management/core/sm-ui-components.js',
        globalCheck: 'window.SMUIComponents',
        description: 'System management UI components',
        required: true
      },
      {
        file: 'scripts/system-management/sections/sm-section-alerts.js',
        globalCheck: 'window.SMSectionAlerts',
        description: 'Alerts section',
        required: true
      },
      {
        file: 'scripts/system-management/sections/sm-section-background-tasks.js',
        globalCheck: 'window.SMSectionBackgroundTasks',
        description: 'Background tasks section',
        required: true
      },
      {
        file: 'scripts/system-management/sections/sm-section-cache.js',
        globalCheck: 'window.SMSectionCache',
        description: 'Cache section',
        required: true
      },
      {
        file: 'scripts/system-management/sections/sm-section-dashboard.js',
        globalCheck: 'window.SMSectionDashboard',
        description: 'Dashboard section',
        required: true
      },
      {
        file: 'scripts/system-management/sections/sm-section-database.js',
        globalCheck: 'window.SMSectionDatabase',
        description: 'Database section',
        required: true
      },
      // REMOVED: sm-section-external-data.js - file does not exist in filesystem
      // REMOVED: sm-section-system-settings.js - file does not exist in filesystem
      {
        file: 'scripts/system-management/sections/sm-section-operations.js',
        globalCheck: 'window.SMSectionOperations',
        description: 'Operations section',
        required: true
      },
      {
        file: 'scripts/system-management/sections/sm-section-performance.js',
        globalCheck: 'window.SMSectionPerformance',
        description: 'Performance section',
        required: true
      },
      {
        file: 'scripts/system-management/sections/sm-section-server.js',
        globalCheck: 'window.SMSectionServer',
        description: 'Server section',
        required: true
      },
      {
        file: 'scripts/system-management/sm-detailed-log.js',
  ...
  management: {
    ...
    scripts: [
      ...
      {
        file: 'scripts/background-tasks.js',
  ...
  'dev-tools': {
    ...
    scripts: [
      {
        file: 'scripts/init-system/dev-tools/page-template-generator.js',
        globalCheck: 'window.PageTemplateGenerator',
        description: 'Page template generator',
        required: true
      },
      {
        file: 'scripts/init-system/dev-tools/script-analyzer.js',
        globalCheck: 'window.ScriptAnalyzer',
        description: 'Script analyzer',
        required: true
      },
      {
        file: 'scripts/init-system/validators/runtime-validator.js',
        globalCheck: 'window.RuntimeValidator',
        description: 'Runtime validator',
        required: true
      },
      {
        file: 'scripts/debug-filter-tooltips-comprehensive.js',
  ...
  'entity_details': {
    ...
    scripts: [
      {
        file: 'scripts/entity-details-api.js',
      ...
      {
        file: 'scripts/entity-details-renderer.js',
      ...
      {
        file: 'scripts/entity-details-modal.js',
  ...
  'info-summary': {
    ...
    scripts: [
      {
        file: 'scripts/info-summary-system.js',
      ...
      {
        file: 'scripts/info-summary-configs.js',
  ...
  'tradingview-charts': {
    ...
    scripts: [
      {
        file: 'scripts/charts/vendor/lightweight-charts.standalone.production.js',
      ...
      {
        file: 'scripts/charts/tradingview-theme.js',
      ...
      {
        file: 'scripts/charts/tradingview-adapter.js',
  ...
  'watch-lists': {
    ...
    scripts: [
      {
        file: 'scripts/services/watch-lists-data.js',
      ...
      {
        file: 'scripts/services/watch-lists-ui-service.js',
      ...
      {
        file: 'scripts/flag-quick-action.js',
  ...
  'ai-analysis': {
    ...
    scripts: [
      ...
      {
        file: 'scripts/ai-analysis-manager.js',
      ...
      {
        file: 'scripts/ai-template-selector.js',
      ...
      {
        file: 'scripts/ai-result-renderer.js',
      ...
      {
        file: 'scripts/ai-notes-integration.js',
      ...
      {
        file: 'scripts/ai-export-service.js',
  ...
  'init-system': {
    ...
    scripts: [
      // NOTE: package-manifest.js is now loaded directly in HTML before loader.js
      // to break the chicken-and-egg dependency. It should NOT be in this list.
      {
        file: 'scripts/sorting-testing-system.js',
      ...
      {
        file: 'scripts/page-initialization-configs.js',
      ...
      {
        file: 'scripts/init-system-check.js',
      ...
      {
        file: 'scripts/monitoring-functions.js',
      ...
      {
        file: 'scripts/widgets/widget-monitor.js',
  ...
  'dashboard-widgets': {
    ...
    dependencies: ['base', 'services', 'ui-advanced', 'entity-services', 'modules', 'entity_details', 'watch-lists'],
    loadingStrategy: 'defer', // Critical package - dashboard widgets, has dependencies on multiple packages
    scripts: [
      {
        file: 'scripts/services/dashboard-data.js',
      ...
      {
        file: 'scripts/widgets/recent-items-widget.js',
      ...
      {
        file: 'scripts/widgets/recent-trades-widget.js',
      ...
      // - TradePlanAssignmentService (replaces pending-trade_plan-widget.js)
      // - ExecutionClusterHelpers (shared rendering helpers)
      // - PendingActionsCacheService (shared cache management)
      {
        file: 'scripts/widgets/unified-pending-actions-widget.js',
      ...
      {
        file: 'scripts/widgets/tag-widget.js',
      ...
      {
        file: 'scripts/active-alerts-component.js',
      ...
      {
        file: 'scripts/widgets/ticker-list-widget.js',
      ...
      {
        file: 'scripts/widgets/ticker-chart-widget.js',
      ...
      {
        file: 'scripts/widgets/watch-lists-widget.js',
  ...
  'dashboard': {
    ...
    scripts: [
      {
        file: 'scripts/trade-selector-modal.js',
  ...
  'tradingview-widgets': {
    ...
    scripts: [
      {
        file: 'scripts/tradingview-widgets/tradingview-widgets-config.js',
      ...
      {
        file: 'scripts/tradingview-widgets/tradingview-widgets-colors.js',
      ...
      {
        file: 'scripts/tradingview-widgets/tradingview-widgets-factory.js',
      ...
      {
        file: 'scripts/tradingview-widgets/tradingview-widgets-core.js',
