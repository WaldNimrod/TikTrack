...
// - ensure() - Ensure
  ...
  const CACHE_TTL_CONFIG = {
    ...
    'trade_plans-data': { ttl: 60 * 1000 }, // Increased from 30s - less frequently changed
    'cash_flows-data': { ttl: 90 * 1000 }, // Increased from 60s - stable data
    ...
    'trading_accounts-data': { ttl: 120 * 1000 }, // Increased from 60s - stable data
    'accounts-data': { ttl: 120 * 1000 }, // Increased from 60s - stable data
    'dashboard_data': { ttl: 60 * 1000 },
    ...
    'trade_history-data': { ttl: 5 * 60 * 1000 }, // 5 minutes
    'trade_history-data-*': { ttl: 5 * 60 * 1000 },
    'trade_history-statistics-*': { ttl: 5 * 60 * 1000 },
    'trade_history-aggregated-*': { ttl: 5 * 60 * 1000 },
    'trade_history-plan-vs-execution-*': { ttl: 5 * 60 * 1000 },
    ...
    'trading_journal-data': { ttl: 3 * 60 * 1000 }, // 3 minutes - changes more frequently
    'trading_journal-data-*': { ttl: 3 * 60 * 1000 },
    'trading_journal-statistics-*': { ttl: 3 * 60 * 1000 },
    'trading_journal-calendar-*': { ttl: 3 * 60 * 1000 },
    'trading_journal-by-entity-*': { ttl: 3 * 60 * 1000 }, // Increased from 60s - validation results are stable
    ...
    'business:validate-trade_plan': { ttl: 120 * 1000 }, // Increased from 60s
    ...
    'trading_journal-data': { ttl: 3 * 60 * 1000 } // 3 minutes
  };
