...
### אחרי (After) - עמודת פעולות 50px:

| עמוד | מספר עמודות | רוחב פעולות אחרי | רוחב כולל אחרי (ללא פעולות) | רוחב כולל אחרי | **חיסכון** |
|------|--------------|------------------|------------------------------|----------------|-----------|
| trades | 12 | 50px | ~1100px | ~1150px | **150px** |
| trade_plans | 11 | 50px | ~1000px | ~1050px | **130px** |
| executions | 10 | 50px | ~900px | ~950px | **130px** |
| tickers | 6 | 50px | ~600px | ~650px | **130px** |
| cash_flows | 7 | 50px | ~700px | ~750px | **130px** |
| alerts | 8 | 50px | ~800px | ~850px | **130px** |
| notes | 6 | 50px | ~600px | ~650px | **130px** |
| trading_accounts | 9 | 50px | ~850px | ~900px | **130px** |

**ממוצע חיסכון:** ~135px (13-15% מרוחב הטבלה!)
