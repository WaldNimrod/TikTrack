    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if hasattr(self, 'ticker') and self.ticker:
                ...
                result["ticker_current_price"] = getattr(self.ticker, 'current_price', 0)
                logger.info(f"Trade {self.id}: Using loaded ticker symbol: {self.ticker.symbol}, price: {result['ticker_current_price']}")
            else:
