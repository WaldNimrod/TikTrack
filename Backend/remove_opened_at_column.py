...
עדכון: אוגוסט 2025
מטרה: הסרת השדה opened_at מטבלת trades כדי למנוע בלבול עם created_at

שינויים:
- הסרת עמודת opened_at מטבלת trades
- העתקת נתונים לטבלה חדשה ללא השדה
- שמירת created_at כמידע היחיד על זמן יצירת הטרייד

סיבות לשינוי:
- בלבול בין opened_at ו-created_at
- created_at מספק את המידע הנדרש
- פשטות המבנה

תוצאה: טבלת trades עם מבנה נקי יותר
"""
