...
# ===== TESTING ENDPOINTS REMOVED FOR PRODUCTION SECURITY =====
# All test endpoints (/api/auth/test/*) have been completely removed to eliminate
# security vulnerabilities and ensure consistent authentication policies.
# Removed endpoints:
# - /api/auth/test/auth-state (GET)
# - /api/auth/test/login (POST)
# - /api/auth/test/logout (POST)
