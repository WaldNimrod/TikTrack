...
⚠️  חשוב: זהו קובץ בדיקות יחידה בלבד!

אין קשר לקונפיגורציות השרת או סביבת הפיתוח!

🎯 מטרה: בדיקת תקינות מודלי בסיס הנתונים של TikTrack
📍 מיקום: Backend/testing_suite/unit_tests/test_models.py
🔗 קונפיגורציות שרת: Backend/SERVER_CONFIGURATIONS.md

🛡️ אמצעי אבטחה:
- שימוש בבסיס נתונים זמני בלבד
- בדיקות מבודדות ללא השפעה על נתונים אמיתיים
