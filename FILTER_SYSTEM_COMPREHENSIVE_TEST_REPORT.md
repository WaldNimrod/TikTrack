...
**בעיה:** חסר `data-account` - הפילטר של חשבון מסחר לא יעבוד בטבלת מעקב!
...
**פתרון:** ✅ הוספת `data-account` attribute ל-cell של חשבון המסחר
**שינוי:**
```javascript
// לפני:
...
2. ✅ **עמוד מעקב** - פילטר חשבון מסחר צריך לעבוד (תוקן data-account)
