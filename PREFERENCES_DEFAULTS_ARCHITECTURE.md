# ארכיטקטורת ברירות מחדל דינמיות - מערכת העדפות

## 📋 **סקירה כללית**

מערכת העדפות עברה שיפור משמעותי בארכיטקטורה - ברירות המחדל עברו מקידוד קשיח בקוד לניהול דינמי באמצעות קובץ JSON. שינוי זה מאפשר גמישות רבה יותר, תחזוקה קלה יותר, ואפשרות לעדכן ברירות מחדל ללא צורך בשינוי קוד.
