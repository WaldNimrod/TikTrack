...
| מזהה | משימה | מקור | סטטוס / הערה |
|------|------|------|--------------|
| **T50.1** | **שער ב' / Regression:** לוודא רשימת ברוקרים מ־API; Rich-Text ללא Inline Style; סניטיזציה (FE + BE) פועלת. | ADR-013, SOP-012 | ✅ הושלם (Gate B 2026-02-11) |
| **T50.2** | **Design System (Type D):** לוודא גישה ל־/admin/design-system רק למשתמש עם תפקיד מנהל; אורח/לא־מנהל מופנה. | ADR-013 §1 (D) | ✅ הושלם (Gate B 2026-02-11) |
