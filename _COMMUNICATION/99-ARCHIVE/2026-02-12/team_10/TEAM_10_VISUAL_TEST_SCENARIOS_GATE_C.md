...
**החלטה (אורח / משתמש לא מורשה):** אורח → הפניה לדף הבית; משתמש מחובר לא מורשה → הודעת חסימה. נבדק בדפדפן בסוף שער ג'.
...
| V18 | **אורח מנסה /admin/design-system** | **מופנה לדף הבית** (redirect ל־/); לא רואה את תוכן הדף. |
| V19 | **משתמש רגיל (לא admin) מנסה /admin/design-system** | **הודעת חסימה** ("אין הרשאה", "חזרה לדף הבית"); לא רואה את תוכן הדף. |
