...
class InitSystemCheck {
    ...
    getCurrentPageName() {
        ...
        if (path.includes('trade_history')) {
            pageName = 'trade_history';
        } else if (path.includes('portfolio-state')) {
            pageName = 'portfolio-state';
        } else if (path.includes('trading_journal')) {
            pageName = 'trading_journal';
        }
        ...
        if (document.documentElement && document.documentElement.className) {
            ...
            // Check if class matches a known page name pattern (e.g., "trading_journal-page")
