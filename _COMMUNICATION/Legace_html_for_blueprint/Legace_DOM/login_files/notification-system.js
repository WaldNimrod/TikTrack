...
// #region agent log
console.log('[notification-system.js] LOADED: Notification system script loaded successfully');
fetch('http://127.0.0.1:7243/ingest/6e906bd0-148a-41fc-aa3b-e13c2ed1de41', {
  method: 'POST',
  headers: {'Content-Type': 'application/json'},
  body: JSON.stringify({
    location: 'notification-system.js:25',
    message: 'Notification system script loaded',
    data: {
      timestamp: Date.now(),
      page: window.location?.pathname || 'unknown'
    },
    sessionId: 'homepage_script_chain_debug',
    runId: 'script_execution_check'
  })
}).catch(() => {});
// #endregion
