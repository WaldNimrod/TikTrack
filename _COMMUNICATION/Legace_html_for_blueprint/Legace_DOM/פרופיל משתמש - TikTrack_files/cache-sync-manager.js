...
class CacheSyncManager {
  constructor() {
    ...
    this.dependencies = {
      ...
      'account_activity-data': ['accounts-data', 'cash_flows-data', 'executions-data'],
      'account_activity-*': ['accounts-data', 'cash_flows-data', 'executions-data'],
      'account-balance-*': ['accounts-data', 'cash_flows-data', 'executions-data'],
    ...
    this.invalidationPatterns = {
      ...
      'account-created': ['trading_accounts-data', 'accounts-data', 'trades-data', 'executions-data', 'dashboard_data', 'business:validate-trading-account*'],
      'account-updated': ['trading_accounts-data', 'accounts-data', 'trades-data', 'executions-data', 'dashboard_data', 'business:validate-trading-account*'],
      'account-deleted': ['trading_accounts-data', 'accounts-data', 'trades-data', 'executions-data', 'dashboard_data', 'business:validate-trading-account*'],
      'trade-created': ['trades-data', 'dashboard_data'],
      'trade-updated': ['trades-data', 'dashboard_data', 'business:calculate-stop-price*', 'business:calculate-target-price*', 'business:calculate-percentage-from-price*'],
      'trade-deleted': ['trades-data', 'dashboard_data'],
      'trade_plan-created': ['trade_plans-data', 'dashboard_data', 'trades-data', 'business:validate-trade_plan*'],
      'trade_plan-updated': ['trade_plans-data', 'dashboard_data', 'trades-data', 'business:validate-trade_plan*'],
      'trade_plan-deleted': ['trade_plans-data', 'dashboard_data', 'trades-data', 'business:validate-trade_plan*'],
      'trade_plan-cancelled': ['trade_plans-data', 'dashboard_data', 'trades-data'],
      'trade_plan-linked': [
        'trades',
        'trade_plans',
        'trades-data',
        ...
        'dashboard',
        'dashboard_data',
        'pending-trade_plan-assignments',
        'pending-trade_plan-creations',
      ],
      'execution-created': ['executions-data', 'dashboard_data', 'account_activity-data', 'account_activity-*', 'account-balance-*', 'positions-account-*', 'portfolio-*', 'portfolio-summary-*', 'business:calculate-execution-values*', 'business:calculate-average-price*'],
      'execution-updated': ['executions-data', 'dashboard_data', 'account_activity-data', 'account_activity-*', 'account-balance-*', 'positions-account-*', 'portfolio-*', 'portfolio-summary-*', 'business:calculate-execution-values*', 'business:calculate-average-price*'],
      'execution-deleted': ['executions-data', 'dashboard_data', 'account_activity-data', 'account_activity-*', 'account-balance-*', 'positions-account-*', 'portfolio-*', 'portfolio-summary-*', 'business:calculate-execution-values*', 'business:calculate-average-price*'],
      'cash-flow-created': ['cash_flows-data', 'account_activity-data', 'account_activity-*', 'account-balance-*', 'dashboard_data', 'business:validate-cash-flow*', 'business:calculate-cash-flow-balance*'],
      'cash-flow-updated': ['cash_flows-data', 'account_activity-data', 'account_activity-*', 'account-balance-*', 'dashboard_data', 'business:validate-cash-flow*', 'business:calculate-cash-flow-balance*'],
      'cash-flow-deleted': ['cash_flows-data', 'account_activity-data', 'account_activity-*', 'account-balance-*', 'dashboard_data', 'business:validate-cash-flow*', 'business:calculate-cash-flow-balance*'],
      'research-data-refresh': ['research-data'],
      'note-created': ['notes-data', 'business:validate-note*', 'business:validate-note-relation*'],
      'note-updated': ['notes-data', 'business:validate-note*', 'business:validate-note-relation*'],
      'note-deleted': ['notes-data', 'business:validate-note*', 'business:validate-note-relation*'],
      'ticker-updated': ['tickers-data', 'market-data', 'business:validate-ticker*', 'business:validate-ticker-symbol*'],
      'currency-updated': ['business:validate-currency-rate*'],
      'tag-created': ['business:validate-tag*', 'business:validate-tag-category*'],
      'tag-updated': ['business:validate-tag*', 'business:validate-tag-category*'],
      'tag-deleted': ['business:validate-tag*', 'business:validate-tag-category*'],
      'alert-created': ['alerts-data', 'dashboard_data'],
      'alert-updated': ['alerts-data', 'dashboard_data', 'business:validate-condition-value*', 'business:validate-alert*'],
      'alert-deleted': ['alerts-data', 'dashboard_data'],
  ...
  async performInvalidateBackend(dependencies) {
    try {
      ...
      const userId = this.getCurrentUserId();
      const response = await fetch('/api/cache_sync/invalidate', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
