# Mandates — S002-P005-WP003  ·  G3_6_MANDATES
...
Verify backend APIs required for: AOS State Alignment & Governance Integrity
...
**Output — write to:**
`_COMMUNICATION/team_20/TEAM_20_S002_P005_WP003_API_VERIFY_v1.0.0.md`
...
- Output saved to: `_COMMUNICATION/team_20/TEAM_20_S002_P005_WP003_API_VERIFY_v1.0.0.md`
...
Implement frontend for: AOS State Alignment & Governance Integrity
...
⚠️  File not yet available. Searched (in order):
  - `_COMMUNICATION/team_20/TEAM_20_S002_P005_WP003_API_VERIFY_v1.0.0.md`
  - `_COMMUNICATION/team_20/TEAM_20_S002_P005_WP003_API_VERIFICATION_v1.0.0.md`
...
Run QA for: AOS State Alignment & Governance Integrity
...
**Output — write to:**
`_COMMUNICATION/team_50/TEAM_50_S002_P005_WP003_QA_REPORT_v1.0.0.md`

### Acceptance
- All FAST_3 checks pass
- No regressions on adjacent pages
- QA report saved to: `_COMMUNICATION/team_50/TEAM_50_S002_P005_WP003_QA_REPORT_v1.0.0.md`
