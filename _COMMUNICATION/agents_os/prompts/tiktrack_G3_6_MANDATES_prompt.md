...
# Mandates — S002-P002-WP001  ·  G3_6_MANDATES
...
[work plan not available — run G3_PLAN first]
...
Verify backend APIs required for: 
...
**Output — write to:**
`_COMMUNICATION/team_20/TEAM_20_S002_P002_WP001_API_VERIFY_v1.0.0.md`
...
- Output saved to: `_COMMUNICATION/team_20/TEAM_20_S002_P002_WP001_API_VERIFY_v1.0.0.md`
...
⚠️  File not yet available. Searched (in order):
  - `_COMMUNICATION/team_20/TEAM_20_S002_P002_WP001_API_VERIFY_v1.0.0.md`
  - `_COMMUNICATION/team_20/TEAM_20_S002_P002_WP001_API_VERIFICATION_v1.0.0.md`
