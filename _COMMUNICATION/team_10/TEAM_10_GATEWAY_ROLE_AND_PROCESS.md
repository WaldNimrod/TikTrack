...
- **לאחר אישור חבילת עבודה (Pre-GATE_3 PASS):** **להוציא את התוכנית לפועל** = להעביר לכל צוות: (1) **קישור לתוכנית המלאה** כקונטקסט, (2) **סדר ביצוע** כולל תלויות ותאומים דרושים, (3) **משימות ספציפיות** לאותו צוות. מסמך מרכזי אחד + פרומט לכל צוות (בבלוק קוד, עם כותרת קנונית) לפי סדר הביצוע.
