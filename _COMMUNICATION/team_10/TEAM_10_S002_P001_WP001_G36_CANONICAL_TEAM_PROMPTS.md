...
**מדריך מאוחד (אין כפילות):** הצגת הודעות בין צוותים — מתי קובץ ומתי בלוק להעתקה: `_COMMUNICATION/PHOENIX_CANONICAL_TEAM_MESSAGE_GUIDE_v1.0.0.md`. המסמך הזה הוא ערוץ **פרומט להעתקה (בלוק)** — לא נוצרים קבצים; כותרת "הודעה לצוות X" + בלוק קוד.
