...
| S8 | **פערים ויזואליים נוספים** | ריכוז כל הממצאים מהבדיקה הוויזואלית; שיוך ל־30/40 וסגירה. | Team 10 (ריכוז); 30/40 (ביצוע) | להקים רשימה אחת כשמתגלים ממצאים |
...
| # | נושא | תיאור | הערה |
|---|------|--------|------|
| S9 | **מיפוי A/B/C/D לכל עמוד** | החלטת אדריכל סופית לכל route + התנהגות redirect ל־D. | אם לא כיסה Q5–Q6/Q11 בסבב המהיר |
| S10 | **/profile — טיפוס C או D** | החלטה סופית + עדכון ROUTES_MAP. | אם לא כיסה Q10 בסבב המהיר |
