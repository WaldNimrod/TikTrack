...
**סטטוס:** מימוש סטטוסים **פעיל**. החלטות עדכון: `TEAM_10_STATUS_IMPLEMENTATION_READINESS_AND_QUESTIONS.md`.

**החלטות מחייבות:**
1. **חובה** — כל מקום שמשתמש בסטטוס יעבור לסטנדרט הסטטוסים (TT2_SYSTEM_STATUS_VALUES_SSOT).
2. **D21 (תזרימי מזומנים)** — **אין סטטוס**; אין סינון/שדה סטטוס ב-D21.
