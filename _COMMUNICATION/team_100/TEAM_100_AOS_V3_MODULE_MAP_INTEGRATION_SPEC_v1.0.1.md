---
id: TEAM_100_AOS_V3_MODULE_MAP_INTEGRATION_SPEC_v1.0.1
...
def approve_gate(
    ...
    # Errors: NOT_HITL_GATE (400), NOT_PRINCIPAL (403), INVALID_STATE (409)
...
def pause_run(
    ...
    # Errors: INVALID_STATE_TRANSITION (409), NOT_PRINCIPAL (403),
...
def resume_run(
    ...
    # Errors: SNAPSHOT_MISSING (409), NOT_PRINCIPAL (403), INVALID_STATE (409),
...
def principal_override(
    ...
    # Errors: NOT_PRINCIPAL (403), INVALID_ACTION (400), TERMINAL_STATE (409),
...
| `NOT_PRINCIPAL` | 403 | actor_team_id ≠ team_00 |
| `INVALID_STATE` | 409 | run.status ≠ IN_PROGRESS |
...
| `NOT_PRINCIPAL` | 403 | actor ≠ team_00 |
