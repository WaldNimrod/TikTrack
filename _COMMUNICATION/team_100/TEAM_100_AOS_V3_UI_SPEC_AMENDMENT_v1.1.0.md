...
correction_cycle: 1
amends:
  - TEAM_100_AOS_V3_MODULE_MAP_INTEGRATION_SPEC_v1.0.1
  - TEAM_100_AOS_V3_UI_SPEC_AMENDMENT_v1.0.2
ssot_basis:
...
| `NOT_PRINCIPAL` | 403 | caller is not team_00 (AD-S8A-04 pattern) |
...
**Reused (not new):** `MISSING_REASON` (Stage 7 §6.1), `DOMAIN_INACTIVE` (Stage 7 §6.1), `RUN_NOT_FOUND` (Stage 7 §6.1), `NOT_PRINCIPAL` (Stage 7 §6.1), `INVALID_STATE` (Stage 7 §6.1).

**Updated total:** 41 (Stage 8A corrected — `NOT_PRINCIPAL` pre-existed in Stage 7 §6.1) + 8 (Stage 8B) = **49 total unique error codes**.
...
| TC-22 | PUT /engine — non-principal | Call PUT /teams/team_21/engine as team_21 (non-team_00) | 403 NOT_PRINCIPAL | §10.3 |
