...
| `00_MASTER_INDEX.md` (root) §Active agent context | עוגן איגנטים — רשימת מסמכים פעילים; מיקום WSM, SSM, רשימות, מפת דרכים. נוהל פעיל: AGENTS_OS_V2_OPERATING_PROCEDURES_v1.0.0. |
