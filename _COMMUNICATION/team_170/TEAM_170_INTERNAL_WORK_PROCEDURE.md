...
| 4 | **הגשה לולידציה צוות 190** | את **האפיון והתיעוד** להגיש **לולידציה של צוות 190**. אין הגשה ישירה לאדריכל לפני PASS של צוות 190 אלא לפי נוהל. |
...
| **GATE_1** | ARCHITECTURAL_DECISION_LOCK (LOD 400) — Team 190 (validation), **Team 170 (documentation registry enforcement)**. | צוות 170: **מחזיק מקורות (originals)**; מפיק אפיון LLD400/Program layer; מוודא יישור לסטנדרטים; בודק תאימות; **מגיש ל־Team 190** לולידציה. אין יצירת Work Package; אין פתיחת GATE_3; אין שינוי SSM/WSM בלי הצדקה פורמלית. |
...
| **3.4** | **הגשה לולידציה צוות 190** | הגשת האפיון והתיעוד ל־Team 190 דרך ערוץ 170↔190; המתנה ל־PASS; טיפול בממצאים חוסמים. רק אחרי PASS — Team 190 מכין חבילת SPEC approval submission (לפי נוהל); אין הגשה ישירה לאדריכל לפני PASS. |
...
**log_entry | TEAM_170 | INTERNAL_WORK_PROCEDURE | MANDATORY_ADOPTED | 2026-02-19**
