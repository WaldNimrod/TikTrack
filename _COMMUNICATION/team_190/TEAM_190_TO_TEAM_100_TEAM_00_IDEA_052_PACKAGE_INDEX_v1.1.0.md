---
id: TEAM_190_TO_TEAM_100_TEAM_00_IDEA_052_PACKAGE_INDEX_v1.1.0
...
gate: IDEA_INTAKE
type: REPORT_INDEX
subject: Navigation index for IDEA-052 DB-first migration package (context-format + cache-governance revision)
supersedes: TEAM_190_TO_TEAM_100_TEAM_00_IDEA_052_PACKAGE_INDEX_v1.0.0.md---
...
`_COMMUNICATION/team_190/TEAM_190_TO_TEAM_100_TEAM_00_IDEA_052_AOS_DATABASE_CONTROL_PLANE_MIGRATION_REPORT_v1.2.2.md`

2. Open issues and questions (decision list):
`_COMMUNICATION/team_190/TEAM_190_TO_TEAM_100_TEAM_00_IDEA_052_ISSUES_AND_OPEN_QUESTIONS_REPORT_v1.2.0.md`
...
- Annex H — 4-layer Context Format Lock + Cache Policy  
...
| Context format policy aligned to existing V2 4-layer model (no new model) | PASS |
| Cache governance policy includes configurable defaults + UI operations | PASS |
| Annexes mapped to decision areas (data, canon, audit, access, cutover, context, cache) | PASS |
| Idea pipeline registration points to IDEA-052 package entrypoint | PASS |

## Architect dive path (time-boxed)

1. 10 min: read executive verdict in main report (`v1.2.2`) §1-§4.
2. 20 min: review decision matrix in issues report (`v1.2.0`) §2.
...
5. 20 min: review Annex H context-format lock + cache policy.
6. 30 min: deep dive by concern using annex mapping table.
7. 10 min: produce lock sheet with eight locked decisions.
...
**log_entry | TEAM_190 | IDEA_052_PACKAGE_INDEX | ARCHITECT_NAVIGATION_ENTRYPOINT_UPDATED | v1.1.0 | 2026-03-23**
