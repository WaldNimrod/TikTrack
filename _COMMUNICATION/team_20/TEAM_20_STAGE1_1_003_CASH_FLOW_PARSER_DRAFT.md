# CASH_FLOW_PARSER — טיוטה להעלאה ל-SSOT

**id:** `TEAM_20_STAGE1_1_003_CASH_FLOW_PARSER_DRAFT`  
**משימה:** 1-003 CASH_FLOW_PARSER  
**בעלים:** Team 20 (לוגיקה) + Team 10 (SSOT)  
**תאריך:** 2026-01-31  
**תלות:** MARKET_DATA_PIPE (רלוונטי — שערים להמרת מטבע)  
**מקום SSOT יעד:** `documentation/01-ARCHITECTURE/CASH_FLOW_PARSER_SPEC.md`  
...
**בקשה ל-Team 10:** לקדם טיוטה זו ל־`documentation/01-ARCHITECTURE/CASH_FLOW_PARSER_SPEC.md`.

**log_entry | TEAM_20 | STAGE1_1_003 | CASH_FLOW_PARSER_DRAFT | 2026-01-31**
