/**
 * Phoenix-Portfolio-Summary-Ver: v2.0.0 | Portfolio Summary Toggle JavaScript
 ...
 * 
 * Usage:
 * Add <script src="./portfolio-summary.js"></script> before closing </body> tag.
  ...
  function initToggle() {
    ...
    if (portfolioToggleBtn && portfolioSummaryContent) {
      portfolioToggleBtn.addEventListener('click', function() {
        const isHidden = portfolioSummaryContent.style.display === 'none' || !portfolioSummaryContent.style.display;
        
        if (isHidden) {
          portfolioSummaryContent.style.display = 'flex';
          ...
          portfolioSummaryContent.style.display = 'none';
