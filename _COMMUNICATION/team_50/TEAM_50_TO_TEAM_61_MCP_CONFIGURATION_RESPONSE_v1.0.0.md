...
### Sanitized snippet (for Codex parity — see §5)
```toml
...
See `_COMMUNICATION/team_50/evidence/mcp_configuration_2026-03-16/tool_list_sanitized.txt` for full list.
...
| 4. Smoke-test procedure provided | PASS — §6 |
| 5. Sanitized evidence included | PASS — §7 |
