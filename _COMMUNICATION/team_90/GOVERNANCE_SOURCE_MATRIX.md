...
| Governance policies | `docs-governance/01-FOUNDATIONS`, `04-PROCEDURES` | Architect + Team 70 | Team 90 governance audit | Team 70 prepares policy deltas -> Team 10 approves -> Team 90 validates -> Team 70 updates | Superseded policy -> governance archive | Active: `documentation/docs-governance/`. Legacy `09-GOVERNANCE/standards/` not in use; see `00_MASTER_INDEX.md` §Active agent context. |
