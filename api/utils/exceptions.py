...
class ErrorCodes:
    ...
    AUTH_EXPIRED_TOKEN = "AUTH_EXPIRED_TOKEN"  # Team 90 SSOT alias
    AUTH_INVALID_TOKEN = "AUTH_INVALID_TOKEN"  # Team 90 SSOT alias
    ...
    ACCESS_DENIED = "ACCESS_DENIED"  # Admin role required (ADR-013, ADMIN_ROLE_MAPPING)
