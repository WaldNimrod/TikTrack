...
class BackgroundTaskManager:
    ...
    def __init__(self, realtime_notifications=None):
        ...
        logger.info("Background Task Manager initialized without WebSocket")
    
    # set_realtime_notifications method removed - using localStorage Events instead
    
    def _notify_task_event(self, event_type: str, task_name: str, **kwargs):
        """Send real-time notification about task event"""
        # WebSocket notifications removed - using localStorage Events instead
        logger.info(f"Background task {event_type}: {task_name}")
    ...
    def _add_to_history(self, entry: Dict[str, Any]):
        ...
        # WebSocket notifications removed - using localStorage Events instead
        logger.debug(f"Background task log saved: {entry.get('task_name')}")
