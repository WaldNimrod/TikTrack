...
class PreferencesService:
    ...
    def __init__(self, db_path: str = None):
        ...
        # ✅ REMOVED: self.cache, self.cache_ttl, self.cache_timestamps
        # Now using AdvancedCacheService instead!
    ...
    def clear_cache(self):
        ...
        try:
            ...
            # 2. Clear legacy self.cache (TODO: remove after full refactoring)
            ...
            logger.info(f"✅ PreferencesService cache cleared: Advanced cache (preferences) + {cache_size} legacy entries")
            return cache_size
        except Exception as e:
