...
console.clear();
console.log('%c🚫 ===== בדיקה ללא !important =====', 'font-size: 20px; font-weight: bold; color: #e74c3c; background: linear-gradient(90deg, #e74c3c, #c0392b); color: white; padding: 15px; border-radius: 10px;');
...
// סיכום
console.log('\n%c🏆 ===== סיכום ללא !important =====', 'font-size: 16px; font-weight: bold; color: #2c3e50; background: rgba(52, 152, 219, 0.1); padding: 10px; border-radius: 8px;');
...
if (copyButton) {
  ...
  if (bgColor.includes('rgba(0, 0, 0, 0)')) {
    ...
    console.log(`%c💡 צריך לחזור ל-!important או למצוא פתרון אחר`, 'color: #3498db; font-weight: bold;');
  } else if (bgColor.includes('rgba(255, 255, 255') || bgColor.includes('white')) {
    console.log(`%c🎉 SUCCESS! הכפתור עם רקע לבן מלא ללא !important!`, 'color: #27ae60; font-weight: bold; background: rgba(39, 174, 96, 0.2); padding: 8px; border-radius: 6px;');
  } else {
    console.log(`%c❓ הכפתור עם רקע אחר`, 'color: #95a5a6; font-weight: bold;');
  }
}

console.log('\n%c🚀 בדיקה ללא !important הושלמה!', 'font-size: 16px; font-weight: bold; color: #9b59b6; background: rgba(155, 89, 182, 0.2); padding: 8px; border-radius: 6px;');
