/**
 * בדיקה אחרי ניקוי מטמון
 * Test after cache clear
 */

console.clear();
console.log('%c🔄 ===== בדיקה אחרי ניקוי מטמון =====', 'font-size: 20px; font-weight: bold; color: #3498db; background: linear-gradient(90deg, #3498db, #2980b9); color: white; padding: 15px; border-radius: 10px;');
