...
**Files:**
> ⚠️ **NON-SSOT:** Communication only - internal team onboarding files

- `_COMMUNICATION/TEAM_20_ONBOARDING_SESSION_01.md` (Communication only)
- `_COMMUNICATION/TEAM_30_ONBOARDING_SESSION_01.md` (Communication only)
- `_COMMUNICATION/TEAM_40_ONBOARDING_SESSION_01.md` (Communication only)
- `_COMMUNICATION/TEAM_50_ONBOARDING_SESSION_01.md` (Communication only)
- `_COMMUNICATION/TEAM_ACTIVATION_SUMMARY_SESSION_01.md` (Communication only)
...
- `_COMMUNICATION/TEAM_00_ARCHITECT_QUERY_SESSION_01.md` ⚠️ **NON-SSOT:** Communication only
- `_COMMUNICATION/TEAM_20_CLARIFICATION_RESPONSE_SESSION_01.md` ⚠️ **NON-SSOT:** Communication only
- `_COMMUNICATION/TEAM_20_FOLLOW_UP_CLARIFICATION_RESPONSE_SESSION_01.md` ⚠️ **NON-SSOT:** Communication only
- `_COMMUNICATION/TEAM_20_FINAL_ACTIVATION_SESSION_01.md` ⚠️ **NON-SSOT:** Communication only
...
- `_COMMUNICATION/team_20_staging/DB_MIGRATION_REFRESH_TOKENS_DRAFT.sql` ⚠️ **NON-SSOT:** Communication only - staging draft ⚠️ **NON-SSOT:** Communication only - staging draft
- 6 Evidence files
