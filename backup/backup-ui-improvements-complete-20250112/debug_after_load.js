// קוד בדיקה אחרי טעינת הטבלה
console.log('🔍 בדיקה אחרי טעינת הטבלה');
...
function debugAfterLoad() {
    ...
    console.log('\n' + '='.repeat(60));
    console.log('✅ בדיקה אחרי טעינה הושלמה');
    console.log('='.repeat(60));
}

// הרצה עם עיכוב
setTimeout(debugAfterLoad, 2000);

// הוספה ל-global scope
window.debugAfterLoad = debugAfterLoad;

console.log('✅ קוד בדיקה אחרי טעינה נטען - הרץ debugAfterLoad() לבדיקה ידנית');
