...
// הרצה עם עיכוב
setTimeout(debugRealtimeCheck, 3000);

// הוספה ל-global scope
window.debugRealtimeCheck = debugRealtimeCheck;

console.log('✅ קוד בדיקה בזמן אמת נטען - הרץ debugRealtimeCheck() לבדיקה ידנית');
