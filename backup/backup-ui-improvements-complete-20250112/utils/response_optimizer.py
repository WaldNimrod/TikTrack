...
class ResponseOptimizer:
    ...
    def add_security_headers(response: Response) -> Response:
        ...
        """
        # Don't add nosniff header for CSS files as it prevents them from loading
        security_headers = ResponseOptimizer.SECURITY_HEADERS.copy()
        content_type = response.headers.get('Content-Type', '')
        
        if 'text/css' in content_type:
            # Remove nosniff header for CSS files
            security_headers.pop('X-Content-Type-Options', None)
