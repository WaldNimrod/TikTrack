                ...
                <tr>
                    ...
                    <td>
                        <div class="btn-group btn-group-sm" role="group">
                            ${window.createButton('VIEW', `window.viewConstraint('${constraint.constraint_name}')`)}
                            ${window.createButton('CHECK', `window.validateConstraint('${constraint.constraint_name}')`)}
                            ${window.createEditButton(`window.editConstraint('${constraint.constraint_name}')`)}
                            ${window.createButton(constraint.is_active ? 'PAUSE' : 'PLAY', `window.toggleConstraint('${constraint.constraint_name}')`)}
                        </div>
                    </td>
                </tr>
            `;
