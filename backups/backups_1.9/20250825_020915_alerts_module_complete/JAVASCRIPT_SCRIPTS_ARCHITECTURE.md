...
מסמך זה מספק דוקומנטציה מקיפה ומפורטת של מבנה הסקריפטים במערכת TikTrack, כולל:

- **ארכיטקטורה כללית** - מבנה הפרויקט וחלוקת האחריות
- **סדר טעינת קבצים** - הסדר המדויק שבו הסקריפטים נטענים
- **אינדקס פונקציות** - רשימה מפורטת של כל הפונקציות בכל קובץ
- **תלויות וקשרים** - מיפוי התלויות בין הקבצים השונים
- **היסטוריית רפקטורינג** - תיעוד השינויים והשיפורים שבוצעו

### 📋 **איך להשתמש במסמך**

1. **למפתחים חדשים** - התחילו מ"ארכיטקטורה כללית" ו"סדר טעינת קבצים"
2. **לחיפוש פונקציה ספציפית** - השתמשו באינדקס הפונקציות לפי קובץ
3. **להבנת תלויות** - בדקו את סעיף "תלויות וקשרים"
4. **להיסטוריית שינויים** - ראה "היסטוריית רפקטורינג"
...
- **main.js:** 10 פונקציות
- **tables.js:** 8 פונקציות
- **ui-utils.js:** 25 פונקציות
- **data-utils.js:** 11 פונקציות
- **date-utils.js:** 15 פונקציות
...
לשאלות, הצעות או דיווח על שגיאות בדוקומנטציה:
- **מפתח ראשי:** צוות הפיתוח של TikTrack
- **תאריך יצירה:** 24 אוגוסט 2025
- **גרסה נוכחית:** 3.0
...
*שם הקובץ: JAVASCRIPT_SCRIPTS_ARCHITECTURE.md*
