...
⚠️  חשוב: זהו קובץ הגדרות מערכת הבדיקות בלבד!

אין קשר לקונפיגורציות השרת או סביבת הפיתוח!

🎯 מטרה: הגדרת סביבת בדיקות בטוחה עם הגנה על בסיס הנתונים
📍 מיקום: Backend/testing_suite/conftest.py
