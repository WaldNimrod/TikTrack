...
2. **שער המידע:** שום שאלה לא עוברת לאדריכלים ללא בדיקה של צוות 10 מול האינדקס המאוחד (00_MASTER_INDEX): ניהול — `documentation/00-MANAGEMENT/00_MASTER_INDEX.md`; אדריכל (חוקי יסוד) — `_COMMUNICATION/_Architects_Decisions/00_MASTER_INDEX.md`.
