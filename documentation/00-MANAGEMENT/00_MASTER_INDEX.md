...
- **Smart History Fill (נעול — SSOT):** [TEAM_20_TO_ARCHITECT_SMART_HISTORY_FILL_SPEC.md](../../_COMMUNICATION/90_Architects_comunication/TEAM_20_TO_ARCHITECT_SMART_HISTORY_FILL_SPEC.md) — Gap-First; Reload רק ב-Admin; 250 ימי מסחר מינימום; Gap = יום חסר בתוך 250; Retry: מיידי + Batch לילה; History: Yahoo → Alpha; Provider: date_from/date_to; API: endpoint יחיד `mode=gap_fill`\|`force_reload`. מפורט ב־MARKET_DATA_PIPE_SPEC §5, MARKET_DATA_COVERAGE_MATRIX Rule 9. **Evidence:** [TEAM_10_SMART_HISTORY_FILL_SSOT_EVIDENCE_LOG.md](../05-REPORTS/artifacts/TEAM_10_SMART_HISTORY_FILL_SSOT_EVIDENCE_LOG.md). **דוח ל-90:** _COMMUNICATION/team_10/TEAM_10_TO_TEAM_90_SMART_HISTORY_FILL_SSOT_UPDATE_REPORT.md. ✅ **LOCKED 2026-02-14**
