...
**אינדקס אדריכל מאוחד (חוקי יסוד System v1.0.0):** `_COMMUNICATION/_Architects_Decisions/00_MASTER_INDEX.md` — BATCH_2_5 (ADR-017), TT2_VERSION_MATRIX_v1.0, ARCHITECT_BROKER_REFERENCE_AND_OTHER_LOGIC (ADR-018). דפי D15_SYSTEM_INDEX מבוטלים (DEPRECATED).
...
- **Smart History Fill (נעול — SSOT):** מפורט ב-[MARKET_DATA_PIPE_SPEC.md](../01-ARCHITECTURE/MARKET_DATA_PIPE_SPEC.md) §5 וב-[MARKET_DATA_COVERAGE_MATRIX.md](../01-ARCHITECTURE/MARKET_DATA_COVERAGE_MATRIX.md) Rule 9 — Gap-First; Reload רק ב-Admin; 250 ימי מסחר מינימום; Gap = יום חסר בתוך 250; Retry: מיידי + Batch לילה; History: Yahoo → Alpha; Provider: date_from/date_to; API: endpoint יחיד `mode=gap_fill`\|`force_reload`. **Evidence:** [TEAM_10_SMART_HISTORY_FILL_SSOT_EVIDENCE_LOG.md](../05-REPORTS/artifacts/TEAM_10_SMART_HISTORY_FILL_SSOT_EVIDENCE_LOG.md). **דוח ל-90:** _COMMUNICATION/team_10/TEAM_10_TO_TEAM_90_SMART_HISTORY_FILL_SSOT_UPDATE_REPORT.md. ✅ **LOCKED 2026-02-14**
- **Yahoo Engine (250d היסטוריה):** v8/chart Primary (range=2y / period1+period2 לגap-fill), dedup, Retry 3×5s (SPEC-PROV-YF-HIST), Fallback yfinance. תיעוד: [YAHOO_FINANCE_DATA_AND_REQUEST_LOGIC.md](../01-ARCHITECTURE/YAHOO_FINANCE_DATA_AND_REQUEST_LOGIC.md) §3.3, [EXTERNAL_PROVIDER_YAHOO_FINANCE_SPEC.md](../90_ARCHITECTS_DOCUMENTATION/EXTERNAL_PROVIDER_YAHOO_FINANCE_SPEC.md). עדכון: _COMMUNICATION/team_20/TEAM_20_TO_TEAM_10_YAHOO_ENGINE_DOCUMENTATION_UPDATE.md. ✅ **2026-02-14**
- **System API — מצב שוק (Market Status):** `GET /api/v1/system/market-status` — Auth; תשובה: `market_state`, `display_label` (Yahoo SPY); מפתח צבעים ליד שעון staleness בדפים: tickers, trading_accounts, cash_flows, brokers_fees (דשבורד נתונים — אופציונלי, לא טוען stalenessClock). מקור: _COMMUNICATION/team_20/TEAM_20_TO_TEAMS_10_30_MARKET_STATUS_UI_COMPLETE.md; מחקר: [TEAM_20_MARKET_STATUS_PROVIDER_RESEARCH.md](../05-REPORTS/artifacts/TEAM_20_MARKET_STATUS_PROVIDER_RESEARCH.md). **QA:** TEAM_50_TO_TEAM_10_MARKET_STATUS_QA_REPORT — PASS; ACK TEAM_10_TO_TEAM_50_MARKET_STATUS_QA_ACK. ✅ **2026-02-14**
...
- **User Tickers ("הטיקרים שלי"):** מקור מחייב — [TEAM_90_TO_TEAM_10_USER_TICKERS_IMPLEMENTATION_BRIEF.md](../../_COMMUNICATION/team_90/TEAM_90_TO_TEAM_10_USER_TICKERS_IMPLEMENTATION_BRIEF.md). תוכנית עבודה: [TEAM_10_USER_TICKERS_WORK_PLAN.md](../../_COMMUNICATION/team_10/TEAM_10_USER_TICKERS_WORK_PLAN.md). **אישור GO:** [TEAM_10_USER_TICKERS_APPROVAL_AND_GO.md](../../_COMMUNICATION/team_10/TEAM_10_USER_TICKERS_APPROVAL_AND_GO.md). **תיקון פערים (Crypto + בורסות):** [TEAM_10_USER_TICKERS_CRYPTO_EXCHANGE_GAPS_AND_CORRECTIVE_PLAN.md](../../_COMMUNICATION/team_10/TEAM_10_USER_TICKERS_CRYPTO_EXCHANGE_GAPS_AND_CORRECTIVE_PLAN.md) — הודעות תיקון: `TEAM_10_TO_TEAM_*_USER_TICKERS_CRYPTO_EXCHANGE_CORRECTIVE.md`; עדכוני SSOT: [TEAM_10_USER_TICKERS_SSOT_CRYPTO_EXCHANGE_UPDATES.md](../../_COMMUNICATION/team_10/TEAM_10_USER_TICKERS_SSOT_CRYPTO_EXCHANGE_UPDATES.md). **דוח בדיקות אחרון + תיקון מהשורש:** [TEAM_10_USER_TICKERS_FINAL_TEST_AND_ROOT_FIX_PLAN.md](../../_COMMUNICATION/team_10/TEAM_10_USER_TICKERS_FINAL_TEST_AND_ROOT_FIX_PLAN.md) — 500→422, Alpha volume bug, provider_mapping_data נעול; הוראת תיקון ל-20: [TEAM_10_TO_TEAM_20_USER_TICKERS_ROOT_FIX_DIRECTIVE.md](../../_COMMUNICATION/team_10/TEAM_10_TO_TEAM_20_USER_TICKERS_ROOT_FIX_DIRECTIVE.md). ⚠️ **לא לסגור עד תיקון פערים ואישור Team 90.** **דוח סופי Team 20:** [TEAM_20_TO_TEAM_10_SUMMARY_AND_DOCUMENTATION_UPDATE.md](../../_COMMUNICATION/team_20/TEAM_20_TO_TEAM_10_SUMMARY_AND_DOCUMENTATION_UPDATE.md). **סטטוס:** [TEAM_10_USER_TICKERS_TEAM_20_FINAL_ACK_AND_STATUS.md](../../_COMMUNICATION/team_10/TEAM_10_USER_TICKERS_TEAM_20_FINAL_ACK_AND_STATUS.md) — **PENDING_VERIFICATION_TOMORROW** (Yahoo 429 / Alpha limit; וריפיקציה חוזרת מחר). Readiness: [USER_TICKER_PAGE_READINESS_REPORT.md](../05-REPORTS/artifacts_SESSION_01/USER_TICKER_PAGE_READINESS_REPORT.md).
...
- [📎 D35 Notes — Rich Text + Attachments Lock (MB3A)](../06-ENGINEERING/PHX_DB_SCHEMA_V2.5_NOTES_ATTACHMENTS_DDL.sql) — SSOT: טבלת `note_attachments`, CHECK גודל 1MB, מכסה 3 קבצים/הערה; [OpenAPI Addendum](../07-CONTRACTS/OPENAPI_SPEC_V2.5.2_NOTES_ATTACHMENTS_ADDENDUM.yaml); [RICH_TEXT_SANITIZATION_POLICY](../../api/utils/RICH_TEXT_SANITIZATION_POLICY.md) (שדה `notes.content`). תוכנית: `_COMMUNICATION/team_10/TEAM_10_NOTES_ALERTS_MINI_BATCH_WORK_PLAN.md` §5. 🔒 **LOCKED 2026-02-15**
- [⚙️ Market Data System Settings (MD-SETTINGS)](../09-GOVERNANCE/TT2_MARKET_DATA_SYSTEM_SETTINGS_SSOT.md) — SSOT: הגדרות מערכת נתוני שוק (DB>env, טווחים, Admin-only). [OpenAPI Addendum](../07-CONTRACTS/OPENAPI_SPEC_V2.5.2_MARKET_DATA_SETTINGS_ADDENDUM.yaml) — GET/PATCH `/settings/market-data` (403, 422). תוכנית: `_COMMUNICATION/team_10/TEAM_10_MARKET_DATA_SETTINGS_UI_WORK_PLAN.md`. 🔒 **LOCKED 2026-02-15** — *בסבב קונסולידציה הבא: לשלב addendum ב-OpenAPI הראשי.*
...
- [🛡️ Governance v2.102 — SOP-013 Seal Message (חסם יחיד לסגירה)](../07-POLICIES/TT2_GOVERNANCE_V2_102_SOP_013_CLOSURE_GATE.md) - סגירת משימות **רק** עם Seal Message (פורמט PHOENIX TASK SEAL); שרשרת פיקוד, PCS רק בסיום באץ', Zero Noise (מחיקת תיעוד זמני). הנחיית אדריכלית: [_COMMUNICATION/_Architects_Decisions/ARCHITECT_DIRECTIVE_GOVERNANCE_STRENGTHENING.md](../../_COMMUNICATION/_Architects_Decisions/ARCHITECT_DIRECTIVE_GOVERNANCE_STRENGTHENING.md). 🛡️ **LOCKED — מחייב 2026-02-13**
