...
- **System API — מצב שוק (Market Status):** `GET /api/v1/system/market-status` — Auth; תשובה: `market_state`, `display_label` (Yahoo SPY); מפתח צבעים ליד שעון staleness בדפים: tickers, trading_accounts, cash_flows, brokers_fees, data dashboard. מקור: _COMMUNICATION/team_20/TEAM_20_TO_TEAMS_10_30_MARKET_STATUS_UI_COMPLETE.md; מחקר: [TEAM_20_MARKET_STATUS_PROVIDER_RESEARCH.md](../05-REPORTS/artifacts/TEAM_20_MARKET_STATUS_PROVIDER_RESEARCH.md). ✅ **2026-02-14**
