...
**log_entry | TEAM_10 | SSOT_UPDATE | SMART_HISTORY_FILL_RULE_9 | 2026-02-14** — Rule 9: Smart History Fill (250d min, Gap-First, Reload Admin only, API mode, Retry). מקור: TEAM_20_TO_ARCHITECT_SMART_HISTORY_FILL_SPEC.
