...
| D34 | D34 | alerts | התראות | ✅ נדרש | נתונים → התראות | **נדרש אפיון** |
| D35 | D35 | notes | הערות | ✅ נדרש | נתונים → הערות | **נדרש אפיון** |
...
| D40 | D40 | system_management | ניהול מערכת | **לא נדרש** (חיוני) | ניהול → ניהול מערכת | — |
