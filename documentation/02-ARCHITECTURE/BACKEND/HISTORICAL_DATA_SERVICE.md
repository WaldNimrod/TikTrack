...
- `trading-ui/scripts/trade_history-page.js` - Trade History Page
- `trading-ui/scripts/portfolio_state-page.js` - Portfolio State Page
- `trading-ui/scripts/trading_journal-page.js` - Trading Journal Page
