...
- מערכת מיפוי טבלאות
- מערכת פילטר ישויות (related-object-filters.js) – החל מ-נובמבר 2025 מפעילה את UnifiedTableSystem + TableDataRegistry עבור פילטרים קנוניים
...
> נשמר לתיעוד היסטורי בלבד; אין פריסה פעילה בממשק.
...
> נשמר למעקב היסטורי בלבד לאחר שהמיפוי שולב בדשבורד איכות הקוד וכלי הסריקה המאוחדים.
- **🟢 חבילת בסיס:** מלא (כל המערכות) _(סטטוס: ארכיון)_
