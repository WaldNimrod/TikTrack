...
2. **`modules/ui-basic.js`** - ממשק משתמש בסיסי (פונקציות סגירה/פתיחה)
3. **`modules/data-basic.js`** - נתונים וטבלאות בסיסיות
4. **`modules/ui-advanced.js`** - ממשק משתמש מתקדם
5. **`modules/data-advanced.js`** - נתונים מתקדמים וולידציה
6. **`modules/business-module.js`** - לוגיקה עסקית והעדפות
7. **`modules/communication-module.js`** - תקשורת API ושגיאות
...
- **פונקציות זמינות** - כל הפונקציות זמינות מיד (כולל toggleAllSections)
