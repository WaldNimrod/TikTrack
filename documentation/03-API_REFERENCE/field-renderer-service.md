...
> **עדכון נובמבר 2025:** כל פונקציות הרינדור המספריות מציגות את סימן הפלוס/מינוס בתחילת הערך, עם סימן המטבע צמוד למספר. לדוגמה:
> - סכומים במטבע: `+$32,518`
> - אחוזים: `+5.20%`
> - ערכים שליליים מוצגים תמיד עם מינוס (`-$12,000`), גם כאשר `showSign=false`.
> - כל הערכים מופקים עם `dir="ltr"` כדי לשמור על סדר אחיד בתוך ממשק RTL.
