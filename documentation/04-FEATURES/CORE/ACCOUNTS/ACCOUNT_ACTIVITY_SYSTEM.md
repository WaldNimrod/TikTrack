...
3. **המרה למטבע בסיס:** סיכום כל היתרות במטבע הבסיס (זמנית - עד לאינטגרציה עם שערי מטבע).
    - ⚠️ **חשוב:** מטבע הבסיס של חשבון נקבע בעת יצירתו ואינו ניתן לשינוי. הסיבה: כל יתרות הפתיחה והיסטוריית ההמרות נבנות על המטבע המקורי. שינוי בדיעבד היה "מתרגם" נתונים היסטוריים למטבע החדש ללא התאמות של שיעורי המרה ויוצר עיוותים בדוחות.
