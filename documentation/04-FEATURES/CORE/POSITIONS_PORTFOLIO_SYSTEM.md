...
- חישוב פוזיציות לפי טיקר+חשבון מסחר
...
- **קישור לטרייד/תוכנית**: אופציונאלי (יכול להיות מספר)
...
### 1. טבלת פוזיציות לפי חשבון מסחר
- Dropdown בחירת חשבון מסחר (ברירת מחדל מהעדפות)
...
### אחוזים
- אחוז משווי חשבון המסחר: `position_value / account_total_value`
