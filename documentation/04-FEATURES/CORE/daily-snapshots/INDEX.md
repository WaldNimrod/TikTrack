...
**קובץ:** [TRADE_HISTORY_SETTINGS_SPEC.md](TRADE_HISTORY_SETTINGS_SPEC.md)

**תיאור:** מפרט מפורט של כל ההגדרות הזמינות בכפתור "הגדרות" בעמוד היסטוריית טרייד.

**תוכן:**
- הגדרות גרפים (נושא, אנימציות, רשת, איכות, רענון)
- הגדרות טיימליין (מצב ברירת מחדל, מרווחים, צבעים)
- הגדרות טבלת ביצועים (עמודות, גודל עמוד, מיון)
- הגדרות סטטיסטיקות (כרטיסים להצגה, סדר)
- הגדרות ייצוא (פורמט, איכות, כלול גרפים)
- הגדרות תצוגה כללית (צפיפות, גודל גופן)
