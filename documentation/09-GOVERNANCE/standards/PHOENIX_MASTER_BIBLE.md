...
### 5.1 צוות 10 (The Gateway) - "מערכת העצבים"
...
### 5.3 צוות 30 (Frontend) - "בוני הלגו"
...
### 5.4 צוות 40 (UI/Design) - "שומרי ה-DNA"
...
### 5.5 צוות 50 (QA/Fidelity) - "שופטי האיכות"
...
### 5.6 צוות 60 (DevOps/Infra) - "ספקי הכלים"
...
**עודכן על ידי:** צוות 10 (The Gateway) | 2026-02-02  
**גרסה:** v2.7 (ריענון נהלים ומשמעת אדריכלית v1.5 + Final Governance Lock v2.0)