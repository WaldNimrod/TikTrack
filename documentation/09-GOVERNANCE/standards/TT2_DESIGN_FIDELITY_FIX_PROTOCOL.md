...
**דיוקי עיצוב / תיקוני עיצוב:** דיוקי עיצוב ותיקוני עיצוב (תפריט, מודולים, וכל מקום) — **הצוותים חייבים לבצע מול G-Lead בלבד**. האדריכלית אינה רואה את הממשק בעין אנושית; **אישור ויזואלי בפועל מבצע G-Lead**. אין שימוש בצילומי מסך לאישור — האישור מתבצע בדפדפן מול G-Lead.
