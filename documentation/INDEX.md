...
- 📘 **Playbook למפתחים – מערכת תנאים**: [CONDITIONS_SYSTEM_DEV_PLAYBOOK.md](04-FEATURES/CORE/conditions-system/CONDITIONS_SYSTEM_DEV_PLAYBOOK.md)
  ...
  - 🎨 **מערכת איקונים מרכזית**: [ICON_SYSTEM_GUIDE.md](frontend/ICON_SYSTEM_GUIDE.md), [ICON_SYSTEM_ARCHITECTURE.md](frontend/ICON_SYSTEM_ARCHITECTURE.md) - ניהול מרכזי של איקונים עם Tabler Icons + 17 איקוני ישויות מקוריים ✅ **חדש! נובמבר 2025**
