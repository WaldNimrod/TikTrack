...
## 🟢 עמודי משתמש עיקריים (24 עמודים - כולם עם authentication מלאה)
...
## 🟡 עמודי בדיקה (16 עמודים - רובם ציבוריים)
...
| עמוד | תיאור | סטטוס |
|------|--------|-------|
| cache-management.html | ניהול מטמון | 🔵 ציבורי |
...
| button-color-mapping-simple.html | מיפוי צבעי כפתורים (פשוט) | 🔵 ציבורי |
...
| עמוד | תיאור | סטטוס |
|------|--------|-------|
| tradingview-widgets-showcase.html | תצוגת ווידג'טים TradingView | 🔵 ציבורי |
