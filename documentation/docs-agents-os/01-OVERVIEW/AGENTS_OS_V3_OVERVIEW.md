...
| Web UI | `agents_os/scripts/start_ui_server.sh` (port **8090** policy for v2 UI) | Static HTML/JS under `agents_os_v3/ui/` (served via local `http.server`; see Developer Runbook) |
