...
| TEAM_10_GATE_ACTIONS_RUNBOOK | פעולות Team 10 לכל שער (PRE_GATE_3..GATE_8) — מקור יחיד לפרט תפעולי | `documentation/docs-governance/04-PROCEDURES/TEAM_10_GATE_ACTIONS_RUNBOOK_v1.0.0.md` | v1.0.0 |
