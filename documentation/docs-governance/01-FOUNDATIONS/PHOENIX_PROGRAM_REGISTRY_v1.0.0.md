...
| S002 | S002-P003 | TikTrack Alignment (D22+D34+D35) | TIKTRACK | ACTIVE | GATE_5 (DEV_VALIDATION — Team 90 owner) |
...
Triggered when: S004-P003 (Spec Draft Generator) reaches GATE_8 PASS
...
**WSM mirror (2026-02-27):** active_stage_id=S002; active_program_id=S002-P003; current_gate=GATE_5 (DEV_VALIDATION — Team 90 owner); active_work_package_id=S002-P003-WP002; active_flow=S002-P003; GATE_5 BLOCK on WP002; remediation required before re-validation.
