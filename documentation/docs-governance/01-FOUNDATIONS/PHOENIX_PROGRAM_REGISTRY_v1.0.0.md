...
| S002 | S002-P003 | TikTrack Alignment (D22+D33+D34+D35) | TIKTRACK | ACTIVE | GATE_7 (HUMAN_SIGNOFF_ACTIVE); active_flow=S002-P003; GATE_6 approved; GATE_7 human sign-off active with Nimrod (Option C browser full walkthrough); active_work_package_id=S002-P003-WP002 |
...
**WSM mirror (2026-03-07):** active_stage_id=S002; active_program_id=S002-P003; current_gate=GATE_7 (HUMAN_SIGNOFF_ACTIVE); active_work_package_id=S002-P003-WP002; active_flow=S002-P003; GATE_6 approved; GATE_7 human sign-off active with Nimrod (Option C browser full walkthrough).
