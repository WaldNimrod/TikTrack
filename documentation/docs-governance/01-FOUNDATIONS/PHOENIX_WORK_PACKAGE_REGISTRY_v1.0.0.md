...
| S002-P003 | S002-P003-WP002 | IN_PROGRESS | GATE_6 (PACKAGE_ROUTING_ACTIVE) | true | S002-P003; GATE_5 PASS on WP002 after G7 rollback remediation; acceptance boundary closed under D22 + D33 + D34 + D35 plus background-task orchestration/addendum scope; GATE_6 package routing active |



**Current active WP state (mirror from WSM):** **ACTIVE_WORK_PACKAGE_PRESENT** — WSM `active_stage_id=S002`, `active_program_id=S002-P003`, `current_gate=GATE_6 (PACKAGE_ROUTING_ACTIVE)`, `active_work_package_id=S002-P003-WP002`.
