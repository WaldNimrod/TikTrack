...
| S002-P003 | S002-P003-WP002 | IN_PROGRESS | GATE_5 (rollback-cycle re-validation blocked) | true | S002-P003; GATE_5 BLOCK on WP002 in G6 rollback cycle; remediation incomplete for GF-G6-003 and returned to Team 10 |



**Current active WP state (mirror from WSM):** **ACTIVE_WORK_PACKAGE_PRESENT** — WSM `active_stage_id=S002`, `active_program_id=S002-P003`, `current_gate=GATE_5 (rollback-cycle re-validation blocked)`, `active_work_package_id=S002-P003-WP002`.
