...
**Mirror source:** pipeline_state_*.json via wsm_sync (S003-P016 — COS removed from WSM; last update 2026-03-24). When no WP is active, no row has `is_active=true`; state is derived from pipeline_state and reflected here.
