...
**Mirror source:** WSM CURRENT_OPERATIONAL_STATE (last update 2026-03-12). When no WP is active, no row has `is_active=true`; state is explicit in WSM and reflected here.
