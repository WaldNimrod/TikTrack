---
id: TEAM_TAXONOMY_v1.0.0
authority: Team 00 — System Designer
date: 2026-03-26
status: SUPERSEDED
superseded_by: TEAM_TAXONOMY_v1.0.1.md
source_roster: TEAMS_ROSTER_v1.0.0.json
---
...
| `gateway` | **שער ביצוע** | Orchestrator — הפעלת צוותים, ניהול gate submissions, עדכון WSM | team_10, team_11 |
...
| `gateway_orchestrator` | **מנהל ביצוע** | ניהול pipeline — הפעלת צוותים, עדכון state, gate submissions | team_10, team_11 |
