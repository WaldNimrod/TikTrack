...
**canonical_path:** documentation/docs-governance/AGENTS_OS_GOVERNANCE/01-FOUNDATIONS/07_TEAM_190_CONSTITUTION.md
...
- Structural DOM Compliance
- state_definitions coverage
- ADR consistency
