...
| D34 | alerts.html | התראות | **5. APPROVED** ✅ (MB3A CLOSED) | Team 31→30/40→20/50/90 | נתונים → התראות; Scope Lock: TEAM_10_MB3A_ALERTS_SCOPE_LOCK.md. Gate-B PASS, Gate-KP + Seal 2026-02-16. |
