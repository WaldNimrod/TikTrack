...
- **Batch Saving**: All changes are saved together when you click "Save Changes"
...
- **Save Changes**: Click "Save Changes" to save all your changes to the server
...
### Actions Available
- **Save Changes**: Click "Save Changes" to save all changes
