...
| Data Collection Service | `trading-ui/scripts/services/data-collection-service.js` | [SERVICES_INTEGRATION_COMPLETION_REPORT.md](../05-REPORTS/SERVICES_INTEGRATION_COMPLETION_REPORT.md) | איסוף/הצבת נתוני טפסים במפה אחידה והמרות טיפוס |
...
| Investment Calculation Service | `trading-ui/scripts/services/investment-calculation-service.js` | [INVESTMENT_CALCULATION_SERVICE.md](../02-ARCHITECTURE/FRONTEND/INVESTMENT_CALCULATION_SERVICE.md) | חישוב דו־כיווני סכום↔כמות↔מחיר + ריסק ברירת מחדל |
...
| Default Value Setter | `trading-ui/scripts/services/default-value-setter.js` | [SERVICES_INTEGRATION_COMPLETION_REPORT.md](../05-REPORTS/SERVICES_INTEGRATION_COMPLETION_REPORT.md) | ברירות מחדל לטפסים (תאריך/שעה/העדפות) וטעינה מרוכזת |
| Field Renderer Service | `trading-ui/scripts/services/field-renderer-service.js` | [FIELD_RENDERER_BUILD_RELATED_ENTITY_META_GUIDE.md](../03-DEVELOPMENT/GUIDES/FIELD_RENDERER_BUILD_RELATED_ENTITY_META_GUIDE.md) | רינדור Status/Amount/Date/Badges אחיד לכל הטבלאות + `buildRelatedEntityMeta()` לרינדור ישויות מקושרות ✅ **חדש! ינואר 2025** |
...
| Tag Service | `trading-ui/scripts/services/tag-service.js`<br>`trading-ui/scripts/tag-ui-manager.js`<br>`Backend/services/tag_service.py` | [TAGGING_SYSTEM_SPEC.md](../03-DEVELOPMENT/TAGGING_SYSTEM_SPEC.md)<br>[TAG_SERVICE_DEVELOPER_GUIDE.md](../03-DEVELOPMENT/GUIDES/TAG_SERVICE_DEVELOPER_GUIDE.md) | מערכת ניהול תגיות: קטגוריות, תגיות, שיוכים, אנליטיקה והצעות |
| Tag Links Cleanup System | `Backend/services/tag_service.py`<br>`Backend/models/*.py`<br>`Backend/scripts/cleanup_orphaned_tag_links.py` | [TAG_LINKS_CLEANUP_SYSTEM.md](../02-ARCHITECTURE/BACKEND/TAG_LINKS_CLEANUP_SYSTEM.md)<br>[TAG_LINKS_CLEANUP_GUIDE.md](../03-DEVELOPMENT/GUIDES/TAG_LINKS_CLEANUP_GUIDE.md) | מערכת ניקוי אוטומטית של tag links בעת מחיקת entities - SQLAlchemy event listeners, ניקוי תקופתי של orphaned links ✅ **חדש! ינואר 2025** |
...
| מערכת | קובץ(ים) עיקריים | דוקומנטציה | הערות |
| --- | --- | --- | --- |
| Icon System | `trading-ui/scripts/icon-system.js`<br>`trading-ui/scripts/icon-mappings.js` | [ICON_SYSTEM_GUIDE.md](ICON_SYSTEM_GUIDE.md)<br>[ICON_SYSTEM_ARCHITECTURE.md](../02-ARCHITECTURE/FRONTEND/ICON_SYSTEM_ARCHITECTURE.md) | ניהול מרכזי של איקונים: 17 איקוני ישויות מקוריים + Tabler Icons, אינטגרציה עם Cache ו-Auto-fallback |
...
| Button System | `trading-ui/scripts/button-system-init.js`<br>`trading-ui/scripts/button-icons.js` | [button_system.md](../02-ARCHITECTURE/FRONTEND/button_system.md) | יצירת כפתורי פעולה, עבודה עם `data-onclick`, כללי נגישות |
| Actions Menu Toolkit | `trading-ui/scripts/modules/actions-menu-system.js`<br>`trading-ui/scripts/ui-utils.js` | [button_system.md](../02-ARCHITECTURE/FRONTEND/button_system.md) | תפריטי פעולה דינמיים לשורות טבלה עם התאמה ל-RTL |
...
| Unified UI Positioning Service | `trading-ui/scripts/services/unified-ui-positioning-service.js` | [UNIFIED_UI_POSITIONING_GUIDE.md](../03-DEVELOPMENT/GUIDES/UNIFIED_UI_POSITIONING_GUIDE.md) | מעטפת אחידה למיקום UI elements באמצעות Floating UI (עם fallback) - מיקום חכם, תמיכה ב-RTL, אנימציות GSAP, אינטגרציה עם WidgetZIndexManager ✅ **חדש! דצמבר 2025** |
| Widget Overlay Service | `trading-ui/scripts/services/widget-overlay-service.js`<br>`trading-ui/styles-new/06-components/_widget-overlay.css` | [WIDGET_OVERLAY_SERVICE_GUIDE.md](../03-DEVELOPMENT/GUIDES/WIDGET_OVERLAY_SERVICE_GUIDE.md)<br>[WIDGET_OVERLAY_SYSTEM.md](../02-ARCHITECTURE/FRONTEND/WIDGET_OVERLAY_SYSTEM.md) | מערכת מרכזית לניהול overlay של פרטים נוספים בוויג'טים - משתמש ב-Unified UI Positioning Service, positioning, event handling, RTL support ✅ **חדש! ינואר 2025** |
| Widget Z-Index Manager | `trading-ui/scripts/services/widget-z-index-manager.js` | [WIDGET_OVERLAY_SYSTEM.md](../02-ARCHITECTURE/FRONTEND/WIDGET_OVERLAY_SYSTEM.md) | ניהול z-index דינמי ל-widget overlays - stack management, dynamic z-index calculation ✅ **חדש! ינואר 2025** |
...
| מערכת | קובץ(ים) עיקריים | דוקומנטציה | הערות |
| --- | --- | --- | --- |
| Logger Service | `trading-ui/scripts/logger-service.js` | [UNIFIED_LOG_SYSTEM_GUIDE.md](../02-ARCHITECTURE/FRONTEND/UNIFIED_LOG_SYSTEM_GUIDE.md)<br>[logger_service.md](../03-API_REFERENCE/logger_service.md) | מערכת לוגים מאוחדת (info/warn/error/debug) + דוחות מפורטים |
