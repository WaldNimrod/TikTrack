...
### ביצועים (Executions)
- **חשבון מסחר** (Trading Account) - חשבון המסחר של הביצוע (חובה)
- **טיקר** (Ticker) - הטיקר של הביצוע (חובה, דרך trade או ישירות)
- **טרייד** (Trade) - הטרייד המקושר לביצוע (אופציונלי)

### תזרימי מזומנים (Cash Flows)
- **חשבון מסחר** (Trading Account) - חשבון המסחר של התזרים (חובה)
- **טרייד** (Trade) - הטרייד המקושר לתזרים (אופציונלי)
- **טיקר** (Ticker) - הטיקר דרך הטרייד (אופציונלי, אם יש trade)
