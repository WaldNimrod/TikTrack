...
6. **הגדרות נפרדות**
   ...
   - `PORT = 5001` תמיד
   - `DATABASE_URL` מצביע ל-PostgreSQL תמיד
...
grep -r "sqlite\|\.db\|tiktrack\.db" production/Backend --include="*.py" | grep -v "deprecated\|legacy\|Development Team" || echo "✅ No SQLite references found"
```
