...
## 1) תפקיד Team 10 — מהות

- **מהות התפקיד:** להחזיק את תהליך הפיתוח — כל פעם של **חבילה אחרת** — עד **השלמתה**. פועלים דרך הפעלת הצוותים המקצועיים (20, 30, 40, 50, 60) כל אחד לפי תפקידו; מנהלים את המשימות שמועברות להם בהתאם ל**תוכנית עבודה** שאותה בניתם; **מעדכנים את סטטוס התהליך באופן קבוע** עם כל התקדמות.
- **בהקשר S002-P002 (MCP-QA):** Gateway Orchestration — בעלים של GATE_3_PREPARATION; מפעיל את חבילת העבודה בהתאם לתנאי טריגר ונקודות גבול נעולות.
