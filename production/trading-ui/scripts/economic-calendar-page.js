 ...
 * 
 * This file handles the economic calendar page functionality for the mockup.
 * 
        ...
        if (typeof window.HeaderSystem !== 'undefined' && typeof window.HeaderSystem.initialize === 'function') {
            ...
            setTimeout(() => {
                if (typeof window.HeaderSystem !== 'undefined' && typeof window.HeaderSystem.initialize === 'function') {
                    ...
                    if (window.Logger) {
                        window.Logger.warn('HeaderSystem not available after retry', { page: 'economic-calendar-page' });
                    }
                }
            }, 500);
        }
