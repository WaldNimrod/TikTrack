...
- **כמות**: 8
- **קבצים מעורבים**: trade_plans.js, notes.js, translation-utils.js, core-systems.js, ui-advanced.js, date-utils.js
...
1. **showNotificationLegacy** (שורה 2825, function) - HIGH
