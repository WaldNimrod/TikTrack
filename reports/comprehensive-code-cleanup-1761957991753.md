...
- **סה"כ קבצים**: 61
- **סה"כ פונקציות**: 835
- **פונקציות לא בשימוש**: 4
- **קבוצות כפולות**: 6
- **פונקציות מקומיות עם תחליף כללי**: 11
...
- **כמות**: 4
- **קבצים מעורבים**: trade_plans.js, notes.js, translation-utils.js, date-utils.js
...
1. **getConditionAttributeOptions** (שורה 839, function) - HIGH
