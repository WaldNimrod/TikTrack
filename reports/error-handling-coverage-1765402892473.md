...
- **trades.js**: 71.95% coverage (need 18.049999999999997% more)
- **executions.js**: 47.73% coverage (need 42.27% more)
- **alerts.js**: 52.73% coverage (need 37.27% more)
