...
- **Total JavaScript Registrations Found:** 13
- **Matched Tables:** 10
- **Unmatched HTML Tables:** 56
- **Unmatched JS Registrations:** 3
- **Tables With Default Sort:** 8
- **Tables Without Default Sort:** 2
...
## Unmatched JavaScript Registrations (3)

| Page | Table Type | Function Name | Has Default Sort |
|------|------------|---------------|------------------|
| entity-details-renderer | position_executions | direct registration | ❌ |
