-- P3: exchange_rates_history — טיוטת DDL (ממתין לאישור אדריכל/Team 10)
-- Source: TEAM_90_TO_TEAM_10_EXTERNAL_DATA_MODULE_REVIEW_AND_EXCHANGE_RATES_HISTORY; MARKET_DATA_PIPE_SPEC §7.3
-- Retention: 250 ימי מסחר → ארכיון (לא מחיקה קשיחה)
-- Job EOD: insert history + UPSERT ל-exchange_rates (נוכחי)
...
COMMENT ON TABLE market_data.exchange_rates_history IS 'Historical FX rates. 250 trading days retention → archive. Per MARKET_DATA_PIPE_SPEC §7.3. DRAFT — await architect approval.';
