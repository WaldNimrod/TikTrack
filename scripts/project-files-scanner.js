  ...
  async discoverAllFiles() {
    ...
    Object.keys(staticFiles).forEach(type => {
      if (discoveredFiles[type]) {
        discoveredFiles[type] = staticFiles[type].filter(file => this.isValidFile(file));
      }
    });
  ...
  getStaticFileLists() {
    return {
      js: [
        ...
        'scripts/external_data_dashboard.js',
        ...
        'scripts/menu.js',
        'scripts/notes.js',
        'scripts/notifications_center.js',
        ...
        'scripts/research.js',
        'scripts/server_monitor-v2.js',
        'scripts/simple-filter.js',
        'scripts/style-demonstration.js',
        'scripts/system_management.js',
        'scripts/table-mappings.js',
        'scripts/test_header_only.js',
