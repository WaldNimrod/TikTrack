...
const PAGES = [
  ...
  { name: 'background-tasks', html: 'background_tasks.html', js: 'scripts/background_tasks.js', category: 'technical' },
  { name: 'server-monitor', html: 'server_monitor.html', js: 'scripts/server_monitor.js', category: 'technical' },
  { name: 'system-management', html: 'system_management.html', js: 'scripts/system_management.js', category: 'technical' },
  { name: 'cache-test', html: 'cache-test.html', js: null, category: 'technical' },
  { name: 'notifications-center', html: 'notifications_center.html', js: 'scripts/notifications_center.js', category: 'technical' },
  { name: 'css-management', html: 'css_management.html', js: 'scripts/css_management.js', category: 'technical' },
  { name: 'dynamic-colors-display', html: 'dynamic_colors_display.html', js: 'scripts/dynamic_colors_display.js', category: 'technical' },
  { name: 'designs', html: 'designs.html', js: 'scripts/designs.js', category: 'technical' },
  { name: 'tradingview-test-page', html: 'tradingview_test_page.html', js: 'scripts/tradingview-test-page.js', category: 'technical' },
  
  // עמודים משניים (2)
  { name: 'external-data-dashboard', html: 'external_data_dashboard.html', js: 'scripts/external_data_dashboard.js', category: 'supporting' },
  { name: 'chart-management', html: 'chart_management.html', js: 'scripts/chart_management.js', category: 'supporting' },
  
  // עמודי מוקאפ (11)
  { name: 'portfolio-state-page', html: 'mockups/daily-snapshots/portfolio_state_page.html', js: 'scripts/portfolio_state-page.js', category: 'mockup' },
  { name: 'trade-history-page', html: 'mockups/daily-snapshots/trade_history_page.html', js: 'scripts/trade_history-page.js', category: 'mockup' },
  { name: 'price-history-page', html: 'mockups/daily-snapshots/price_history_page.html', js: 'scripts/price-history-page.js', category: 'mockup' },
  { name: 'comparative-analysis-page', html: 'mockups/daily-snapshots/comparative_analysis_page.html', js: 'scripts/comparative-analysis-page.js', category: 'mockup' },
  { name: 'trading-journal-page', html: 'mockups/daily-snapshots/trading_journal_page.html', js: 'scripts/trading_journal-page.js', category: 'mockup' },
  { name: 'strategy-analysis-page', html: 'mockups/daily-snapshots/strategy_analysis_page.html', js: 'scripts/strategy_analysis-page.js', category: 'mockup' },
  { name: 'economic-calendar-page', html: 'mockups/daily-snapshots/economic_calendar_page.html', js: 'scripts/economic-calendar-page.js', category: 'mockup' },
  { name: 'history-widget', html: 'mockups/daily-snapshots/history_widget.html', js: 'scripts/history-widget.js', category: 'mockup' },
  { name: 'emotional-tracking-widget', html: 'mockups/daily-snapshots/emotional_tracking_widget.html', js: 'scripts/emotional-tracking-widget.js', category: 'mockup' },
  { name: 'date-comparison-modal', html: 'mockups/daily-snapshots/date_comparison_modal.html', js: 'scripts/date-comparison-modal.js', category: 'mockup' },
  { name: 'tradingview-test-page-mockup', html: 'mockups/daily-snapshots/tradingview_test_page.html', js: 'scripts/tradingview-test-page.js', category: 'mockup' },
];
