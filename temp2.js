(function() {
  ...
  /**
     ...
     */
  const replaceIconsWithIconSystem = async () => {
  ...
  /**
     ...
     */
  const enhanceCalendarWithEODData = async (eodPortfolioData, year, month) => {
  ...
  /**
     ...
     */
  const generateEntityTypeFilterButtons = async() {
    try {
  ...
  /**
     ...
     */
  const loadAndRenderJournalEntries = async() {
    try {
  ...
  /**
     ...
     */
  const handleEntryClickById = async(entityType, entityId) {
  ...
  /**
     ...
     */
  const zoomToDay = async(day, month, year) {
    if (window.Logger) {
  ...
  /**
     ...
     */
  const renderJournalEntriesTableForModal = async(entries, container) {
    if (!Array.isArray(entries) || entries.length === 0) {
      container.innerHTML = `
                <div class="alert alert-info text-center w-100">
                    <span class="icon-placeholder icon" data-icon="info-circle" data-size="16" data-alt="info-circle" aria-label="info-circle"></span>
  ...
  /**
     ...
     */
  const renderJournalEntriesCardsForModal = async(entries, container) {
    if (!Array.isArray(entries) || entries.length === 0) {
      container.innerHTML = `
                <div class="alert alert-info text-center w-100">
                    <span class="icon-placeholder icon" data-icon="info-circle" data-size="16" data-alt="info-circle" aria-label="info-circle"></span>
