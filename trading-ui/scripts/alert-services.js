/**
 * Alert Services - TikTrack Alert Management Services
 * ==================================================
 * 
 * קובץ שירותים גלובלי לניהול התראות
 * מכיל פונקציות גלובליות לתרגום תנאי התראות וניהול התראות
 * 
 * File: trading-ui/scripts/alert-services.js
 * Version: 1.0.0
 * Last Updated: August 26, 2025
 * 
 * Features:
 * - תרגום תנאי התראות לעברית עם סימנים חשבונאיים
 * - תמיכה בפורמט החדש (3 שדות נפרדים)
 * - תמיכה בפורמט הישן (מחרוזת אחת)
 * - פונקציות עזר לניהול התראות
 * 
 * Usage:
 ...
 * - window.findAlertById(alertId) - חיפוש התראה לפי מזהה
 * - window.getConditionAttributeOptions() - אפשרויות תכונות
 * - window.getConditionOperatorOptions() - אפשרויות אופרטורים
 */
...
console.log('🔧 Alert Services loaded successfully');
