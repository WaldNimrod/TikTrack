...
class SmartInitialization {
    ...
    isDevelopmentPage(pageName) {
        const devPages = [
            'system-management', 'crud-testing-dashboard', 
            'external-data-dashboard', 'linter-realtime-monitor',
            'notifications-center', 'db_display'
        ];
    ...
    isManagementPage(pageName) {
        const managementPages = [
            'trading_accounts', 'cash_flows', 'notes'
        ];
