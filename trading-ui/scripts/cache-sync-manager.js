...
class CacheSyncManager {
  constructor() {
    ...
    this.invalidationPatterns = {
      ...
      'account-created': ['trading-accounts-data', 'accounts-data', 'trades-data', 'executions-data', 'dashboard-data', 'business:validate-trading-account*'],
      'account-updated': ['trading-accounts-data', 'accounts-data', 'trades-data', 'executions-data', 'dashboard-data', 'business:validate-trading-account*'],
      'account-deleted': ['trading-accounts-data', 'accounts-data', 'trades-data', 'executions-data', 'dashboard-data', 'business:validate-trading-account*'],
      ...
      'trade-plan-created': ['trade-plans-data', 'dashboard-data', 'trades-data', 'business:validate-trade-plan*'],
      'trade-plan-updated': ['trade-plans-data', 'dashboard-data', 'trades-data', 'business:validate-trade-plan*'],
      'trade-plan-deleted': ['trade-plans-data', 'dashboard-data', 'trades-data', 'business:validate-trade-plan*'],
      ...
      'cash-flow-created': ['cash-flows-data', 'account-activity-data', 'account-activity-*', 'account-balance-*', 'dashboard-data', 'business:validate-cash-flow*', 'business:calculate-cash-flow-balance*'],
      'cash-flow-updated': ['cash-flows-data', 'account-activity-data', 'account-activity-*', 'account-balance-*', 'dashboard-data', 'business:validate-cash-flow*', 'business:calculate-cash-flow-balance*'],
      'cash-flow-deleted': ['cash-flows-data', 'account-activity-data', 'account-activity-*', 'account-balance-*', 'dashboard-data', 'business:validate-cash-flow*', 'business:calculate-cash-flow-balance*'],
