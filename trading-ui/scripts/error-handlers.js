...
function handleApiError(error, context = 'API_CALL', userMessage = null) {
  // לוג מפורט למפתחים
  // // console.warn(`🔧 API Error in ${context}:`, error); // Disabled for linting
...
function handleElementNotFound(elementId, fallback = 'ELEMENT_NOT_FOUND') {
  // // console.warn(`🔧 Element not found: ${elementId} - ${fallback}`); // Disabled for linting
...
function handleFunctionNotFound(functionName, fallback = 'FUNCTION_NOT_FOUND') {
  // // console.warn(`🔧 Function not found: ${functionName} - ${fallback}`); // Disabled for linting
...
function handleValidationError(field, message) {
  // // console.warn(`🔧 Validation error in ${field}: ${message}`); // Disabled for linting
...
function handleDataLoadError(error, dataType) {
  // // console.warn(`🔧 Data load error for ${dataType}:`, error); // Disabled for linting
...
function handleSaveError(error, operation) {
  // // console.warn(`🔧 Save error for ${operation}:`, error); // Disabled for linting
...
function handleDeleteError(error, itemType) {
  // // console.warn(`🔧 Delete error for ${itemType}:`, error); // Disabled for linting
...
function handleSystemError(error, system) {
  // // console.warn(`🔧 System error in ${system}:`, error); // Disabled for linting
