...
if (document.readyState === 'loading') {
  ...
  generateScriptTagsForPage(pageName) {
    const pageConfigs = {
      'executions': ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system'],
      'cash_flows': ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system'],
      'trades': ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system'],
      'tickers': ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system'],
      'alerts': ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system'],
      'trading_accounts': ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system'],
      'notes': ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system'],
      'trade_plans': ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system']
    };
    
    const packages = pageConfigs[pageName] || ['base', 'services', 'ui-advanced', 'crud', 'preferences', 'init-system'];
