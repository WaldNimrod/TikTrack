...
const PAGE_REQUIREMENTS = {
  ...
  'code-quality-dashboard': {
    modules: ['core-systems', 'ui-basic', 'ui-advanced', 'data-advanced', 'communication-module'],
    description: 'דשבורד איכות קוד - כולל ניטור Linter וכלי איכות מתקדמים',
  },
  'chart-management': {
    modules: ['core-systems', 'ui-basic', 'ui-advanced', 'data-basic'],
...
function getModulesByCategory(category) {
  return Object.keys(MODULE_CONFIGS).filter(name => MODULE_CONFIGS[name].category === category);
}
