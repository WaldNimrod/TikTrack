...
class ProjectFilesScanner {
    ...
    getStaticFileLists() {
        return {
            js: [
                // ONLY files that are actually loaded in linter-realtime-monitor.html
                ...
                'scripts/charts/chart-loader.js',
                'scripts/charts/chart-theme.js',
                'scripts/charts/chart-system.js',
                'scripts/charts/adapters/linter-adapter.js',
