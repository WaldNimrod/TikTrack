...
async function loadTradePlansData() {
    try {
        console.log('🔄 Loading trade plans data from server...');
        ...
        if (!responseData.data) {
            console.error('❌ Server response does not contain data field');
            tradePlansData = [];
            isDataLoaded = true;
            return [];
        }
        ...
        console.log(`✅ Using demo data: ${tradePlansData.length} trade plans`);
        return tradePlansData;
    }
}
