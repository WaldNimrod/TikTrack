/**
 * בדיקה פשוטה של העדפות וצבעים
 * Simple preferences and colors check
 */

console.clear();
console.log('%c🔍 ===== בדיקה פשוטה של העדפות וצבעים =====', 'font-size: 20px; font-weight: bold; color: #3498db; background: linear-gradient(90deg, #3498db, #2980b9); color: white; padding: 15px; border-radius: 10px;');
...
// 5. ניסיון לעדכן CSS Variables מהעדפות
console.log('\n%c🎨 5. ניסיון לעדכן CSS Variables מהעדפות:', 'font-size: 16px; font-weight: bold; color: #2c3e50;');
...
// 6. ניסיון להחיל צבעים על כותרות
console.log('\n%c🎨 6. ניסיון להחיל צבעים על כותרות:', 'font-size: 16px; font-weight: bold; color: #2c3e50;');

if (window.applyEntityColorsToHeaders) {
  console.log('%c🔄 קורא ל-applyEntityColorsToHeaders...', 'color: #3498db;');
  try {
    window.applyEntityColorsToHeaders('execution');
    console.log('%c✅ applyEntityColorsToHeaders הושלם', 'color: #27ae60;');
    ...
    console.log(`%c❌ שגיאה ב-applyEntityColorsToHeaders: ${error.message}`, 'color: #e74c3c;');
  }
} else {
  console.log('%c❌ applyEntityColorsToHeaders לא זמין', 'color: #e74c3c;');
}
