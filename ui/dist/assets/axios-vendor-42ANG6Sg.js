...
const { toString: mt } = Object.prototype,
  ...
  { iterator: re, toStringTag: Ke } = Symbol,
  se = ((e) => (t) => {
    const n = mt.call(t);
...
const bt = oe('string'),
  ...
  Et = F('Date'),
  gt = F('File'),
  St = (e) => !!(e && typeof e.uri < 'u'),
  Ot = (e) => e && typeof e.getParts < 'u',
  Tt = F('Blob'),
  At = F('FileList'),
  Ct = (e) => V(e) && A(e.pipe);
function xt() {
...
const Ne = xt(),
  Pe = typeof Ne.FormData < 'u' ? Ne.FormData : void 0,
  _t = (e) => {
    let t;
    return (
      e &&
  ...
  Nt = F('URLSearchParams'),
  [Pt, Ft, Ut, Lt] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(
    F,
  ),
  Dt = (e) =>
...
const k =
  ...
  Qe = (e) => !H(e) && e !== k;
function he() {
  const { caseless: e, skipUndefined: t } = (Qe(this) && this) || {},
    n = {},
    r = (s, o) => {
...
const Zt = (e) => {
  ...
  Yt = F('AsyncFunction'),
  en = (e) => e && (V(e) || A(e)) && A(e.then) && A(e.catch),
  Ye = ((e, t) =>
    e
      ? setImmediate
      : t
...
function ie(e, t, n) {
  ...
  function l(u, m, d) {
    ...
    if (u && !d && typeof u == 'object') {
      if (a.endsWith(m, '{}'))
        ...
        (a.isArray(u) && sn(u)) ||
        ((a.isFileList(u) || a.endsWith(m, '[]')) && (w = a.toArray(u)))
      )
        return (
          (m = tt(m)),
  ...
  function g(u, m) {
    if (!a.isUndefined(u)) {
      ...
      (h.push(u),
        a.forEach(u, function (w, x) {
          (!(a.isUndefined(w) || w === null) &&
            s.call(t, w, a.isString(x) ? x.trim() : x, m, b)) === !0 &&
            g(w, m ? m.concat(x) : [x]);
        }),
        h.pop());
    }
...
function rt(e, t, n) {
  ...
  if (
    (o
      ? (i = o(t, s))
      : (i = a.isURLSearchParams(t) ? t.toString() : new Re(t, s).toString(r)),
    i)
  ) {
    const c = e.indexOf('#');
    (c !== -1 && (e = e.slice(0, c)),
...
const Ee = {
  ...
  cn = typeof URLSearchParams < 'u' ? URLSearchParams : Re,
  ln = typeof FormData < 'u' ? FormData : null,
  un = typeof Blob < 'u' ? Blob : null,
  fn = {
    isBrowser: !0,
    classes: { URLSearchParams: cn, FormData: ln, Blob: un },
  ...
  hn = (ge && window.location.href) || 'http://localhost',
  mn = Object.freeze(
    ...
    return (
      ...
      p
        ...
        : ((!s[i] || !a.isObject(s[i])) && (s[i] = []),
          t(n, r, s[i], o) && a.isArray(s[i]) && (s[i] = wn(s[i])),
          !c)
    );
  }
...
let C = class {
  ...
  set(t, n, r) {
    ...
    else if (a.isString(t) && (t = t.trim()) && !On(t)) i(gn(t), n);
...
`);
  ...
  static accessor(t) {
    const r = (this[De] = this[De] = { accessors: {} }).accessors,
      s = this.prototype;
    function o(i) {
      const c = z(i);
      r[c] || (An(s, i), (r[c] = !0));
...
const ct = (e) => {
    ...
    if (
      ...
      (r && a.isFunction(r) && (r = r(t)), r || (r !== !1 && Nn(t.url)))
    ) {
    ...
    function (e) {
      return new Promise(function (n, r) {
        ...
        ('onloadend' in d
          ...
          f && (([b, u] = ne(f, !0)), d.addEventListener('progress', b)),
          p &&
            d.upload &&
            (([h, g] = ne(p)),
  ...
  jn = async function* (e, t) {
    for await (const n of qn(e)) yield* kn(n, t);
  },
  qn = async function* (e) {
  ...
  Ie = 64 * 1024,
  { isFunction: Z } = a,
  In = (({ Request: e, Response: t }) => ({ Request: e, Response: t }))(
    a.global,
  ),
  { ReadableStream: He, TextEncoder: Me } = a.global,
  $e = (e, ...t) => {
    try {
      return !!e(...t);
    } catch {
  ...
  Hn = (e) => {
    e = a.merge.call({ skipUndefined: !0 }, In, e);
    ...
    const c = s && Z(He),
      ...
      l = i && c && $e(() => a.isReadableStream(new r('').body)),
      h = { stream: l && ((u) => u.body) };
    s &&
    ...
    return async (u) => {
      ...
      let G = Bn([x, E && E.toAbortSignal()], O),
        $ = null;
      const B =
        G &&
        G.unsubscribe &&
      ...
      try {
        if (
          ...
          let L = new n(m, { method: 'POST', body: w, duplex: 'half' }),
            I;
          if (
            (a.isFormData(w) &&
        ...
        if (l && (P || (xe && B))) {
          ...
          const I = a.toFiniteNumber(U.headers.get('content-length')),
            [le, Q] = (P && Be(I, ne(ke(P), !0))) || [];
          U = new r(
            qe(U.body, Ie, le, () => {
              (Q && Q(), B && B());
            }),
        ...
        _ = _ || 'text';
        let ht = await h[a.findKey(h, _) || 'text'](U, u);
        return (
          !xe && B && B(),
  ...
  lt = (e) => {
    ...
    for (; c--; )
      ((p = o[c]),
        (f = l.get(p)),
        f === void 0 && l.set(p, (f = c ? new Map() : Hn(t))),
        (l = f));
    return f;
  };
lt();
const Se = { http: rn, xhr: Dn, fetch: { get: lt } };
a.forEach(Se, (e, t) => {
  if (e) {
    try {
...
function zn(e, t) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    if (
      ((s = r),
      !$n(r) && ((s = Se[(c = String(r)).toLowerCase()]), s === void 0))
    )
...
const ut = { getAdapter: zn, adapters: Se };
function pe(e) {
  if (
...
export { R as a };
//# sourceMappingURL=axios-vendor-42ANG6Sg.js.map
