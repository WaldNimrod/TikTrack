...
const HomePage = () => {
  ...
  const handleSectionToggle = (sectionId) => {
    ...
    debugLog('HomePage', `Section ${sectionId} toggled`, {
  ...
  const handlePortfolioSummaryToggle = () => {
    ...
    debugLog('HomePage', 'Portfolio summary toggled', {
      isOpen: !showPortfolioSummary,
    });
  };
  ...
  useEffect(() => {
    const checkAuth = async () => {
      ...
      try {
        ...
        debugLog(
          'HomePage',
          'Auth check failed - showing Guest Container',
          error,
        );
      } finally {
                ...
                <tt-section>
                  <div className="guest-container">
                    <div className="guest-container__header">
                      <h1 className="guest-container__title">
                        ברוכים הבאים ל-TikTrack
                      </h1>
                      <p className="guest-container__subtitle">
                ...
                <tt-section data-section="top">
                  ...
                  <div className="index-section__header">
                    <div className="index-section__header-title">
                      <img
                        ...
                        height="20"
                      />
                      <h1 className="index-section__header-text">
                        דף הבית - TikTrack
                      </h1>
                    </div>
                    <div className="index-section__header-actions">
                      ...
                      {!openSections['top'] && alertsCount > 0 && (
                        ...
                        >
                          <span className="index-section__header-alert-icon">
                            🔔
                          </span>
                          <span className="index-section__header-alert-count">
                            {alertsCount}
                          </span>
                        </a>
                      )}
                  ...
                  {openSections['top'] && (
                    <div className="index-section__body">
                      <AlertsSummaryWidget
                        onData={({ total }) => setAlertsCount(total)}
                      />
                      {/* Summary Information */}
                      <div className="info-summary" id="summaryStats">
                        ...
                        <div className="info-summary__row info-summary__row--first">
                          <div className="info-summary__content">
                            <div>
                              סה&quot;כ טריידים:{' '}
                              <strong id="totalTrades">82</strong>
                            </div>
                            <div>
                              סה&quot;כ התראות:{' '}
                              <strong id="totalAlerts">3</strong>
                            </div>
                            <div>
                              יתרה נוכחית:{' '}
                              <strong id="currentBalance">
                                <span
                                  className="numeric-value-positive"
                                  dir="ltr"
                                >
                                  +$372,660.00
                                </span>
                        ...
                        {showPortfolioSummary && (
                          <div
                            className="info-summary__row info-summary__row--second"
                      ...
                      <tt-section-row>
                        ...
                        <div className="widget-placeholder">
                          <div className="widget-placeholder__header">
                            ...
                            <ul
                              className="widget-placeholder__tabs"
                              role="tablist"
                            >
                              <li
                                className="widget-placeholder__tab-item"
                                role="presentation"
                              >
                                <button
                                  ...
                                  role="tab"
                                  aria-selected={
                                    activeTabs['recentTrades'] ===
                                    'recentTradesPane'
                                  }
                                  aria-controls="recentTradesPane"
                                  onClick={() =>
                                    handleWidgetTabChange(
                                      'recentTrades',
                                      'recentTradesPane',
                                    )
                                  }
                          ...
                          <div className="widget-placeholder__body">
                            {activeTabs['recentTrades'] ===
                              'recentTradesPane' && (
                              <div
                                className="widget-placeholder__tab-content"
                                id="recentTradesPane"
                                role="tabpanel"
                              >
                                <ul className="widget-placeholder__list">
                                  ...
                                  <li className="widget-placeholder__list-item">
                                    <div className="widget-placeholder__item-header">
                                      <div className="widget-placeholder__item-title">
                                        ...
                                        />
                                        <span className="widget-placeholder__item-name">
                                          SPY
                                        </span>
                                      </div>
                                      <div className="widget-placeholder__item-meta">
                                        <span
                                          ...
                                          data-status-category="open"
                                        >
                                          פתוח
                                        </span>
                                        <span className="widget-placeholder__item-date">
                                          25.01.26
                                        </span>
                                      </div>
                                  ...
                                  <li className="widget-placeholder__list-item">
                                    <div className="widget-placeholder__item-header">
                                      ...
                                      <div className="widget-placeholder__item-amount">
                                        <span
                                          className="numeric-value-negative"
                                          dir="ltr"
                                        >
                                          -$45.20
                                        </span>
                            ...
                            {activeTabs['recentTrades'] ===
                              'recentPlansPane' && (
                              <div
                                className="widget-placeholder__tab-content widget-placeholder__tab-content--hidden"
                                id="recentPlansPane"
                                role="tabpanel"
                              >
                                <ul className="widget-placeholder__list">
                          ...
                          <div className="widget-placeholder__header">
                            <div className="widget-placeholder__header-title-row">
                              ...
                              <div className="widget-placeholder__header-badges">
                                <span className="widget-placeholder__badge">
                                  0
                                </span>
                              </div>
                            </div>
                          ...
                          <div className="widget-placeholder__body">
                            {activeTabs['pendingActions'] ===
                              ...
                              <div
                                ...
                                role="tabpanel"
                              >
                                <p className="widget-placeholder__text">
                                  כל הטריידים מלווים בתוכנית מתאימה. עבודה
                                  מצוינת!
                                </p>
                              </div>
                            )}
                        ...
                        <div className="widget-placeholder">
                          <div className="widget-placeholder__header">
                            <div className="widget-placeholder__header-title-row">
                              ...
                              <form className="widget-placeholder__search-form">
                                ...
                                />
                                <select
                                  className="widget-placeholder__search-select"
                                ...
                                <button
                                  type="submit"
                                  className="widget-placeholder__search-btn"
                                  aria-label="חפש"
                                >
                                  <svg
                                    width="16"
                          ...
                          <div className="widget-placeholder__body">
                            <div className="widget-placeholder__tag-cloud">
                              <button
                                className="widget-placeholder__tag-btn"
                                type="button"
                              >
                                🏷️ test tag
                              </button>
                        ...
                        <div className="widget-placeholder">
                          <div className="widget-placeholder__header">
                            <div className="widget-placeholder__header-title-row">
                              ...
                              <button
                                className="widget-placeholder__refresh-btn align-push-down"
                                aria-label="רענן"
                                title="רענן"
                              >
                                <svg
                            ...
                            >
                              ...
                              >
                                <button
                                  ...
                                  role="tab"
                                  aria-selected={
                                    activeTabs['tickerList'] === 'tickerAllPane'
                                  }
                            ...
                            <div className="widget-placeholder__chart-grid">
                              ...
                              <div className="widget-placeholder__chart-item">
                                <div className="widget-placeholder__chart-header">
                                  <div className="widget-placeholder__item-title">
                                    <strong className="widget-placeholder__item-symbol">
                                      AAPL
                                    </strong>
                                    <span className="widget-placeholder__item-name">
                                      Apple Inc.
                                  ...
                                  <button
                                    className="widget-placeholder__action-btn"
                                    aria-label="דשבורד"
                                    title="דשבורד"
                                  >
                                    <svg
                  ...
                  <div className="index-section__header">
                    ...
                    <div className="index-section__header-actions">
                      ...
                      <div className="portfolio-header-filters">
                        ...
                        {/* Side Filter Buttons */}
                        <div
                          className="portfolio-side-filters align-push-down"
                          role="group"
                        ...
                        <div className="portfolio-checkboxes-container align-push-down">
                          <label className="portfolio-checkbox-label">
                            <input
                              ...
                              className="portfolio-checkbox-input"
                            />
                            <span className="portfolio-checkbox-text">
                              הצג פוזיציות סגורות
                            </span>
                          </label>
                          <label className="portfolio-checkbox-label">
                        ...
                        >
                          <thead>
                            <tr>
                              ...
                              <th className="col-percent-portfolio">
                                % פורטפוליו
                              </th>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td className="col-side">
                                <span className="side-badge side-badge--long">
                                  ↑
                                </span>
                              </td>
                              ...
                              <td className="col-unrealized-pl">
                                <span
                                  className="numeric-value-positive"
                                  dir="ltr"
                                >
                            ...
                            <tr>
                              <td className="col-side">
                                <span className="side-badge side-badge--short">
                                  ↓
                                </span>
                              </td>
