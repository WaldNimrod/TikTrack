    ...
    <footer className="page-footer" dir="rtl">
      <div className="page-footer__container">
        ...
        <div className="page-footer__column">
          ...
          <p className="page-footer__text">
            <Link to="/portfolio" className="page-footer__link">
              פורטפוליו
            </Link>
          </p>
          <p className="page-footer__text">
            <Link to="/trades" className="page-footer__link">
              טריידים
            </Link>
          </p>
          <p className="page-footer__text">
            <Link to="/research" className="page-footer__link">
              מחקר
            </Link>
          </p>
          <p className="page-footer__text">
            <Link to="/settings" className="page-footer__link">
              הגדרות
            </Link>
          </p>
        </div>
