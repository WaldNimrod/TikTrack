...
(function initHeaderLinks() {
  ...
  async function handleLogout() {
    try {
      ...
      if (
        window.authService &&
        typeof window.authService.logout === 'function'
      ) {
      ...
      window.maskedLog?.('[Header Links Updater] Logout error:', {
  ...
  function updateManagementMenuVisibility() {
    const el =
      document.getElementById('nav-management') ||
      document.querySelector(
        '.tiktrack-nav-item.dropdown[data-admin-only="true"]',
      );
    if (!el) return;
  ...
  function updateHeaderLinks() {
    ...
    if (
      logoLink &&
      (!logoLink.href || logoLink.href === '#' || logoLink.href.endsWith('#'))
    ) {
      logoLink.href = '/';
    }

    // Gate B Fix: Update financial pages links to use .html extension (per routes.json)
    const tradingAccountsLinks = document.querySelectorAll(
      'a[href="/trading_accounts"], a[href="/trading_accounts.html"], a[data-page="trading_accounts"]',
    );
    ...
    const brokersFeesLinks = document.querySelectorAll(
      'a[href="/brokers_fees"], a[href="/brokers_fees.html"], a[data-page="brokers_fees"]',
    );
    ...
    const cashFlowsLinks = document.querySelectorAll(
      'a[href="/cash_flows"], a[href="/cash_flows.html"], a[data-page="cash_flows"]',
    );
    ...
    const dataDashboardLinks = document.querySelectorAll(
      'a[href="/data_dashboard"], a[href="/data_dashboard.html"], a[data-page="data_dashboard"]',
    );
    ...
    const userTickersLinks = document.querySelectorAll(
      'a[href="/user_tickers"], a[href="/user_tickers.html"], a[data-page="user_tickers"]',
    );
    ...
    const tradePlansLinks = document.querySelectorAll(
      'a[href="/trade_plans"], a[href="/trade_plans.html"], a[data-page="trade_plans"]',
    );
    ...
    const aiAnalysisLinks = document.querySelectorAll(
      'a[href="/ai_analysis"], a[href="/ai_analysis.html"], a[data-page="ai_analysis"]',
    );
    ...
    const tradesLinks = document.querySelectorAll(
      'a[href="/trades"], a[href="/trades.html"], a[data-page="trades"]',
    );
    ...
    const tradesHistoryLinks = document.querySelectorAll(
      'a[href="/trades_history"], a[href="/trades_history.html"], a[data-page="trades_history"]',
    );
    ...
    const userProfileLinks = document.querySelectorAll(
      'a[href="/user_profile"], a[href="/profile"], a[data-page="user_profile"]',
    );
    ...
    Object.keys(navLinks).forEach((path) => {
      ...
      links.forEach((link) => {
        ...
        if (
          ...
          !link.href.endsWith(navLinks[path])
        ) {
          link.href = navLinks[path];
        }
      });
