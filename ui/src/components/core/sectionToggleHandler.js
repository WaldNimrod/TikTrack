...
(function initSectionToggle() {
  ...
  function toggleAllSections(container) {
    ...
    sections.forEach((section) => {
      ...
      const toggleBtn = section.querySelector(
        '.index-section__header-toggle-btn, .dashboard-section__header-toggle-btn',
      );
      const icon = toggleBtn?.classList.contains('js-expand-collapse-all')
        ? null
    ...
    if (expandBtn)
      expandBtn.setAttribute(
        'aria-label',
        openAll ? 'סגור את כל האזורים' : 'פתח את כל האזורים',
      );
  }
  ...
  function initToggleButtons() {
    ...
    const toggleButtons = document.querySelectorAll(
      '.index-section__header-toggle-btn.js-section-toggle, .dashboard-section__header-toggle-btn.js-section-toggle',
    );
