...
const ICONS = {
  ...
  underline: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M6 3v7a6 6 0 0 0 12 0V3"/><line x1="4" y1="21" x2="20" y2="21"/></svg>',
  ...
  orderedList: '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="9" y1="6" x2="21" y2="6"/><line x1="9" y1="12" x2="21" y2="12"/><line x1="9" y1="18" x2="21" y2="18"/><path d="M5 6V4h2v2M5 12h2M4 17h1.5a1 1 0 0 1 1 1v.5"/></svg>'
};

const ICON_MAP = {
  bold: 'bold', italic: 'italic', underline: 'underline',
  'phx-success': 'success', 'phx-warning': 'warning', 'phx-danger': 'danger', 'phx-highlight': 'highlight',
  heading3: 'h3', heading4: 'h4',
  alignLeft: 'alignLeft', alignCenter: 'alignCenter', alignRight: 'alignRight', alignJustify: 'alignJustify',
  dirLtr: 'ltr', dirRtl: 'rtl',
...
const ROW1_STYLES = [
  ...
  { sepBefore: true },
  { cmd: 'phx-success', title: 'Success', icon: 'success', cssClass: 'phx-rt--success' },
  { cmd: 'phx-warning', title: 'Warning', icon: 'warning', cssClass: 'phx-rt--warning' },
  { cmd: 'phx-danger', title: 'Danger', icon: 'danger', cssClass: 'phx-rt--danger' },
  { cmd: 'phx-highlight', title: 'Highlight', icon: 'highlight', cssClass: 'phx-rt--highlight' },
  { sepBefore: true },
...
export const PHOENIX_RT_TOOLBAR_BUTTONS = Object.freeze([...ROW1_STYLES, ...ROW2_ALIGN_LISTS]);
