...
const PasswordResetFlow = () => {
  ...
  const validateRequestForm = () => {
    ...
    } = validatePasswordResetRequestForm(requestData);
  ...
  const validateVerifyForm = () => {
    const currentMethod = resetToken ? 'EMAIL' : 'SMS';
    const { isValid, errors } = validatePasswordResetVerifyForm(
      verifyData,
      currentMethod,
    );
    setFieldErrors(errors);
  ...
  const handleRequestSubmit = async (e) => {
    ...
    if (!validateRequestForm()) {
      debugLog('Auth', 'Password reset request validation failed', {
        fieldErrors,
      });
      return;
    }
  ...
  const handleVerifySubmit = async (e) => {
    ...
    if (!validateVerifyForm()) {
      debugLog('Auth', 'Password reset verify validation failed', {
        fieldErrors,
      });
      return;
    }
    ...
    debugLog('Auth', 'Password reset verify started', {
            ...
            <tt-section>
              <div className="auth-header">
                ...
                <p className="auth-subtitle">
                  הזן אימייל או טלפון לקבלת קישור איפוס
                </p>
              ...
              >
                ...
                >
                  ...
                  {method === 'EMAIL' ? 'האימייל' : 'ה-SMS'} שלך.
                </div>
