...
const PasswordChangeForm = () => {
  ...
  const handleInputChange = (e) => {
    ...
    switch (name) {
      case 'currentPassword':
        ...
        break;
      case 'newPassword':
        validationResult = validatePasswordChange(
          value,
  ...
  const validateForm = () => {
    ...
    if (!isValid) {
      debugLog('PasswordChangeForm', 'Form validation failed', {
        fieldErrors: errors,
      });
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      debugLog(
        'PasswordChangeForm',
        'Password change payload prepared',
        payload,
      );
      ...
      <tt-container>
        <tt-section>
          ...
          >
            ...
            {error && (
              <div
                className="auth-form__error js-error-feedback js-password-change-error"
                role="alert"
                aria-live="polite"
              >
                {error}
            ...
            {success && (
              <div
                className="auth-form__success js-success-feedback js-password-change-success"
                role="alert"
              >
                {success}
              </div>
