...
(function initHeaderHandlers() {
  ...
  function updateFilterDisplay() {
    ...
    const commissionTypeFilterToggle = document.getElementById(
      'commissionTypeFilterToggle',
    );
    const selectedCommissionTypeText = document.getElementById(
      'selectedCommissionTypeText',
    );
    if (commissionTypeFilterToggle && selectedCommissionTypeText) {
      selectedCommissionTypeText.textContent =
        currentFilters.commissionType || 'כל סוג עמלה';
    }
  }
