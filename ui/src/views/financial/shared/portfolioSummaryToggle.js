...
(function initPortfolioSummary() {
  ...
  function initToggle() {
    const portfolioToggleBtn = document.getElementById(
      'portfolioSummaryToggleSize',
    );
    const portfolioSummaryContent = document.getElementById(
    ...
    if (portfolioToggleBtn && portfolioSummaryContent) {
      portfolioToggleBtn.addEventListener('click', function () {
        const isExpanded =
          portfolioSummaryContent.classList.contains('is-expanded');
        ...
        if (isExpanded) {
          ...
          portfolioToggleBtn.innerHTML =
            '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"></path><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6"></path></svg>';
        } else {
