        ...
        <td class="phoenix-table__cell col-actions phoenix-table__cell--actions" role="cell">
          <div class="table-actions-tooltip">
            ...
            <div class="table-actions-menu">
              <button class="table-action-btn js-action-view" aria-label="צפה" title="צפה" data-account-id="${account.externalUlid || account.id || ''}">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                  <circle cx="12" cy="12" r="3"></circle>
                </svg>
              </button>
              <button class="table-action-btn js-action-edit" aria-label="ערוך" title="ערוך" data-account-id="${account.externalUlid || account.id || ''}">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                </svg>
              </button>
              <button class="table-action-btn js-action-delete" aria-label="מחק" title="מחק" data-account-id="${account.externalUlid || account.id || ''}">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
