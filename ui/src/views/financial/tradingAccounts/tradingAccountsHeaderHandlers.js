    ...
    if (clearButton && searchInput) {
      clearButton.addEventListener('click', function (e) {
        ...
        if (
          ...
          const filters =
            window.TradingAccountsFiltersIntegration.getGlobalFilters();
  ...
  function initFilterClearButton() {
    ...
    if (clearButton) {
      clearButton.addEventListener('click', function (e) {
        ...
        const accountByDatesSelect = document.getElementById(
          'accountByDatesSelect',
        );
        const accountByDatesDateFrom = document.getElementById(
          'accountByDatesDateFrom',
        );
        const accountByDatesDateTo = document.getElementById(
          'accountByDatesDateTo',
        );
        const positionsAccountSelect = document.getElementById(
          'positionsAccountSelect',
        );
